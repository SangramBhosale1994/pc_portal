<?php include(\ProcessWire\wire('files')->compile('includes/tis_header_2023.php',array('includes'=>true,'namespace'=>true,'modules'=>true,'skipIfNamespace'=>true))); ?>
<style>
...
.social-icon1 {
							...
							<div class="mt-4 grid-intro-item col-lg-1-5 col-md-4 col-sm-6 col-12 pb-0">
								<div class="portfolio-item">
									...
									<?php 
										...
										{
										?>
									    <a target="_blank" href="<?=$social_media_repeater->covid_19_title;?>" class="social-icon1 social-icon si-colored si-<?=$social_media_repeater->title;?>" title="<?=$social_media_repeater->title;?>">
									...
									<div class="portfolio-desc center pb-0">
										...
										<h3 class="blue-font"><?=$speakers_detials->speaker_pronoun;?></h3>
										...
										<h3 class="title_new center " style="margin: 7px;"><?=$sponsorships_repeater->title;?></h3>
											<div class="story-box-content mt-2">
												...
												<div class="row justify-content-center  mb-3 mt-3">
													...
													?>
													<!-- <a class="flex-spacing" class="btn-outline-primary-new font-weight-light button ml-0 button-rounded"  href="<?=$rise_past_section_buttons->heading3;?>"><?=$rise_past_section_buttons->heading2;?></a> -->
													<a href="<?=$rise_past_section_buttons->heading3;?>"  class="btn-outline-primary-new font-weight-light button ml-0 button-rounded"><?=$rise_past_section_buttons->heading2;?></a>
													<?php
													}
													?>
												</div>
							...
							<div class="story-box-info p-3" style="border: 1px solid rgba(0, 0, 0, 0.125);border-radius: 0.25rem;background-color:#5bcffa;">
								...
								<div class="event-passes-spacing mt-3 event-passes-text-color event-passes-ul-style event_passes_text">
									...
									<div class="">
										...
										<div class="row justify-content-center  mb-3 mt-3">
											<a class="flex-spacing" href="<?=$event_passes_repeater->heading4;?>"><button style="font-weight: 550 !important;" class="pinkbutton btn-outline-event-passes font-weight-light button ml-0 button-rounded"><?=$event_passes_repeater->heading3;?></button></a>
										</div>
									</div>
							</div>
						</div>
	...
	<?php include(\ProcessWire\wire('files')->compile('includes/tis_footer_2023.php',array('includes'=>true,'namespace'=>true,'modules'=>true,'skipIfNamespace'=>true))); ?>