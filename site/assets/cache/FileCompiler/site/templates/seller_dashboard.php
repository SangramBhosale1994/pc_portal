<?php
 require_once(\ProcessWire\wire('files')->compile('includes/seller-header.php',array('includes'=>true,'namespace'=>true,'modules'=>true,'skipIfNamespace'=>true)));
...
// 		$document_first = new \ProcessWire\WireUpload('document_legal_agreement');
// //echo $resume;
...
/* Uploading and saving of Resume. (Same process as image upload) */
		$document_second = new \ProcessWire\WireUpload('document_onboarding_form');
//echo $resume;
// echo "1";
// echo time();
// echo "\n";
...
/* Uploading and saving of Document third. (Same process as image upload) */
		$document_third = new \ProcessWire\WireUpload('document_pan');
//echo $resume;
// echo "5";
// echo time();
// echo "\n";
...
/* Uploading and saving of Document four. (Same process as image upload) */
		$document_fourth = new \ProcessWire\WireUpload('document_gst');
//echo $resume;
...
/* Uploading and saving of document_fourth END */
		...
		/* Uploading and saving of Resume. (Same process as image upload) */
		$document_fifth = new \ProcessWire\WireUpload('document_pan_directors');
//echo $resume;
...
// 			$data_to_return->error_text[] = "No resume uploaded. Please upload your resume.";
		...
		/* Uploading and saving of Resume END */
			...
			/* Uploading and saving of Resume. (Same process as image upload) */
		$document_sixth = new \ProcessWire\WireUpload('document_cancelled_cheque');
//echo $resume;
