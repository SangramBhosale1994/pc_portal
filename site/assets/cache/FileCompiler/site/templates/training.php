<?php
 include(\ProcessWire\wire('files')->compile('includes/training-header.php',array('includes'=>true,'namespace'=>true,'modules'=>true,'skipIfNamespace'=>true)));
...
if (isset($_POST['btn-send'])) {
  ...
  $daily_updates = $_POST['daily_updates'];
  ...
  $offerings = $sanitizer->text($input->post->offerings);
  $daily_updates = $sanitizer->text($input->post->daily_updates);
  ...
  $new_profile_page->title = $name;
  $new_profile_page->heading2 = $email;
  $new_profile_page->first_name = $phone;
  $new_profile_page->heading4 = $designation;
  $new_profile_page->heading5 = $company;
  $new_profile_page->heading6 = $offerings;
  $new_profile_page->heading7 = $daily_updates;
                                    ...
                                    <div class="modal-dialog" role="document">
                                      <div class="modal-content1 modal-content">
                                        ...
                                        <div class="row modal-body justify-content-center">
                                          <div class="text-center title-center title-border title_height">
                                            <h3 class="title_new" style="margin: 0 0 1px 0;">Access Demo Modules</h3>
                                            <div>Please fill in the details to access the demo modules</div>
                                          </div>
                                                ...
                                                <div class="modal-body" style="padding: 0.1rem;">
                                                  ...
                                                  <div class="row">
                                                    <div class="col-md-6 col-sm-12 form-group">
                                                      ...
                                                      <input type="tel" id="phone" name="phone" class="sm-form-control" value="" placeholder="Phone number with country code (Optional)">
                                                    </div>

                                                    <div class="col-md-6 col-sm-12 form-group">
                                                      <input type="text" name="designation" id="user_designation" class="required sm-form-control" value="" placeholder="Your Designation*" required>
                                                    </div>
                                                  </div>
                                                  <div class="form-group">
                                                    <input type="text" name="company" id="user_Company" class="required sm-form-control" value="" placeholder="Your Company Name*" required>
                                                  </div>
                                                  <div class="form-group">
                                                    <legend style="font-size: 1rem;">Are you interested in learning about our offerings?*</legend>
                                                    <div style="display: flex;">
                                                      <div style="margin-right: 1rem">
                                                        <input type="radio" id="foundational1-Yes" name="offerings" value="yes" checked>
                                                        <label for="yes" style="font-weight: 500;">Yes</label>
                                                      </div>
                                                      <div>
                                                        <input type="radio" id="foundational1-No" name="offerings" value="no">
                                                        <label for="no" style="font-weight: 500;">No</label>
                                                      </div>
                                                    </div>
                                                  </div>
                                                  <div class="form-group">
                                                    <legend style="font-size: 1rem;">Do you want us to email you the monthly updates (events, workshops, etc.)?*</legend>
                                                    <div style="display: flex;">
                                                      <div style="margin-right: 1rem">
                                                        <input type="radio" id="foundational2-Yes" name="daily_updates" value="yes" checked>
                                                        <label for="yes" style="font-weight: 500;">Yes</label>
                                                      </div>
                                                      <div>
                                                        <input type="radio" id="foundational2-No" name="daily_updates" value="no">
                                                        <label for="no" style="font-weight: 500;">No</label>
                                                      </div>
                                                    </div>
                                                  </div>
          ...
          <div class="carousel-inner">
            ...
            if (isset($_GET['success'])) {
              ...
              if ($current_timestamp < $url_timestamp) {
                $thank_you = $pages->get("name=success-message")->heading2;
                $msg =
                  '<div id="toast-container" class="toast-top-right">
                  <div class="toast toast-success" aria-live="polite" style="">
                    <div class="toast-message">
                      <div class="feature-box fbox-center fbox-dark fbox-plain">
                        <div class="fbox-icon" style="margin-bottom: 0.1rem;">
                          <a href="#"><i class="icon-thumbs-up"></i></a>
                        </div>
                        <div class="fbox-content">
                          <strong>' . $pages->get("name=success-message")->heading2 . '</strong>
                          <p style="color: #326251;">' . $pages->get("name=success-message")->text_description . '</p>
                        </div>
                      </div>
                    </div>
                  </div>
                                              ...
                                              <form action="" id="main-container<?= $slider_counter ?>" method="POST" class="mb-1">
                                                <div class="modal-body" style="padding: 0.1rem;">
                                                  ...
                                                  <div class="form-group">
                                                    ...
                                                    <div style="display: flex;">
                                                      <div style="margin-right: 1rem">
                                                        <input type="radio" id="intermediate1-Yes" name="offerings" value="yes" checked>
                                                        <label for="yes" style="font-weight: 500;">Yes</label>
                                                      </div>
                                                      <div>
                                                        <input type="radio" id="intermediate1-No" name="offerings" value="no">
                                                        <label for="no" style="font-weight: 500;">No</label>
                                                      </div>
                                                    </div>
                                                  </div>
                                                  <div class="form-group">
                                                    ...
                                                    <div style="display: flex;">
                                                      <div style="margin-right: 1rem">
                                                        <input type="radio" id="intermediate2-Yes" name="daily_updates" value="yes" checked>
                                                        <label for="yes" style="font-weight: 500;">Yes</label>
                                                      </div>
                                                      <div>
                                                        <input type="radio" id="intermediate2-No" name="daily_updates" value="no">
                                                        <label for="no" style="font-weight: 500;">No</label>
                                                      </div>
                                                    </div>
                                                  </div>
  ...
  <section id="" style="background:#41007a;">
    <div class="container" style="background:#41007a;">
      ...
      <div class="container mt-5 ">
        <!-- <div class="row justify-content-center col-mb-50 mb-0"> -->
        <form action="" class="form-info requires-validation" method="post" id="contact_form">
          <div class="row grid-container lets_talk_container" data-layout="masonry" style="overflow: visible">
            <div class="col-md-3">
              <div class="form-group">
                <input type="text" class="required form-control" id="user_name" name="user_name" placeholder="YOUR NAME" required>
              </div>
            </div>
            <div class="col-md-3">
              <div class="form-group">
                <input type="email" class="required form-control" id="user_email" name="user_email" aria-describedby="emailHelp" placeholder="YOUR EMAIL" required>
              </div>
            </div>
            <div class="col-md-3">
              <div class="form-group">
...
<!-- js by pooja for email validation  -->
<script>
  ...
  emailInputs.forEach(input => {
    input.addEventListener("input", function() {
      ...
      const comRegEx = /.+\.(com|in)$/;

      if (!emailRegEx.test(email) || !comRegEx.test(email)) {
        input.setCustomValidity("Please enter a valid email address with a '.com' extension.");
      } else {
...
<?php include(\ProcessWire\wire('files')->compile('includes/training-footer.php',array('includes'=>true,'namespace'=>true,'modules'=>true,'skipIfNamespace'=>true))); ?>