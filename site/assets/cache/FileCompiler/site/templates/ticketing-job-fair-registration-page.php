...
// echo "<br>==4==<br>"; 
		        $single_applicant=new \ProcessWire\Page();
...
// echo "<br>==7==<br>"; 	
			  ...
			  //   $single_applicant->save();
	    		...
	    		try {
					...
					$candidate_page=\ProcessWire\wire("pages")->get("name=candidates")->child("id=".$candidate_job_fair->page_id);
        		
					if($candidate_page->lgbtq_verification=="Confirmed"){

					 /* pass applicants save pass verification verified and send mail*/
						
						$job_fair_page = \ProcessWire\wire("pages")->get("name=pass-applicants")->child("candidate_profile_id=".$candidate_page->id);
