<?php 
echo $session->hackps;
 require_once(\ProcessWire\wire('files')->compile('includes/header.php',array('includes'=>true,'namespace'=>true,'modules'=>true,'skipIfNamespace'=>true)));
		...
		<!--	</div>-->
			...
			<div class="<?php if($referrer_code_cookie_value !== false){echo "d-none";} ?> [ my-5 ][ form-group ]">
			    ...
			    ?>
					...
					<option value="" <?php if($referrer_code_cookie_value === false){echo "selected";} ?> hidden>How did you learn about us?</option>
...
<?php require_once(\ProcessWire\wire('files')->compile('includes/footer.php',array('includes'=>true,'namespace'=>true,'modules'=>true,'skipIfNamespace'=>true)))?>
