...
//echo $_POST['create_new_modal_submit'];
    if(isset($_POST['create_new_modal_submit'])){
      //echo "1";     
        $new_job_page = new \ProcessWire\Page();
        ...
        // $new_job_page->is_popup_show_event = $sanitizer->text($input->post->job_show_popup);
        if($input->post->job_show_popup != ""){
		    $new_job_page->is_popup_show_event = $sanitizer->text($input->post->job_show_popup);
  	    }
		else{
			$new_job_page->is_popup_show_event = "hide";
		}
...
// 		echo "1";
    ...
    // echo $input->post->job_show_popup;
    // echo "****";
    // die();
 ...
 <!--action="<?=$config->urls->httpRoot?>resume/api/admin-manage-jobs/"-->
				<form id="create_new_modal_form" class="[ needs-validation ]" method="POST" enctype="multipart/form-data">
					<div id="edit_profile_modal_body" class="[ modal-body ]">
                        ...
                        <div class="[ mb-3 ][ form-group ]">
							<!-- <label for="create_new_job_show_popup">Is show about job popup to candidate?</label><br> -->
							<div class="ml-4">
								<input class="form-check-input" type="checkbox" value="show" id="create_new_job_show_popup" name="job_show_popup">
								<label class="form-check-label" for="create_new_job_show_popup" >Show "How did you know about the job?" popup</label>
								<div class="invalid-tooltip">
			...
			<div class="[ modal-content ]">
                ...
                <form id="edit_profile_modal_form" class="[ needs-validation ]" autocomplete="off" action="<?=$pages->get("name=admin-manage-jobs-edit-job")->httpUrl?>" method="POST" enctype="multipart/form-data" target="_blank">
					<div id="edit_profile_modal_body" class="[ modal-body ]">
                        ...
                        <div class="[ mb-3 ][ form-group ]">
							<!-- <label for="edit_profile_show_job_popup">Is show about job popup to candidate?</label><br> -->
							<div class="ml-4">
								<input class="form-check-input" type="checkbox" value="show" id="edit_profile_show_job_popup" name="edit_job_show_popup">
								<label class="form-check-label" for="edit_profile_show_job_popup" >Show "How did you know about the job?" popup</label>
								<div class="invalid-tooltip">
									Please provide a valid answer.
								</div>
							</div>
            			...
            			<div class="[ mb-3 ][ form-group ]">
            				...
            				<div class="custom-file">
            					<input id="edit_job_profile_image" name="edit_job_profile_image" class="custom-file-input" type="file" autocomplete="off">
	...
	<script src="<?= $rootpath;?>scripts/<?=$page->template?>.js?v=23.04.2022"></script>
