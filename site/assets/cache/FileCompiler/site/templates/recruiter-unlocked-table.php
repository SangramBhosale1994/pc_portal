...
?>
				...
				<div class="container-fluid recruiter_datatable_section">
					...
					<div class="card shadow mb-4">
						...
						<label class="btn btn-outline-primary"><input id='show_only_mine_checkbox' class='show_only_mine_checkbox' type='checkbox' style="padding-top:0.5rem;"> My Unlocks</label>
