...
?><html>
	...
	<head>
		...
		<meta property="og:image" content='<?php echo $pages->get("name=home")->httpUrl.$config->urls->templates."images/equally_share.jpg"; ?>'>
...
<link href="https://fonts.googleapis.com/css?family=Lato:300,400,400i,700|Poppins:300,400,500,600,700|PT+Serif:400,400i&display=swap" rel="stylesheet" type="text/css" />
	...
	<div class=" py-0" style="margin-top:2rem; margin-bottom:2rem;">
				<div class="container">
