...
?>
      ...
      <!--                      </div>-->
						<!--</div>-->
						<?php 
						   // foreach($pages->get("name=other-programs-jan-to-dec")->children() as $other_program_page){
						?>
   ...
   <!--                 	    <span>-->
   <!--                 	    In case of any questions, please email us at <a href="mailto:rise@thepridecircle.com?Subject=Query%20Regarding%20the%20dashboard" title="Mail Us">rise@thepridecircle.com</a></span>-->
   <!--                 	</div>-->
