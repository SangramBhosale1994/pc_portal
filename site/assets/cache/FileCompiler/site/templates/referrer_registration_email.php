...
// require_once(\ProcessWire\wire('files')->compile("vendor/autoload.php",array('includes'=>true,'namespace'=>true,'modules'=>true,'skipIfNamespace'=>true)));
...
<head>
	<?php
 include(\ProcessWire\wire('files')->compile('includes/general_referrer_header.php',array('includes'=>true,'namespace'=>true,'modules'=>true,'skipIfNamespace'=>true)));
		?>
