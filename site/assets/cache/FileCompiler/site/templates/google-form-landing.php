...
<head>
	...
	<!-- Global site tag (gtag.js) - Google Analytics -->
    <!-- <script async src="https://www.googletagmanager.com/gtag/js?id=G-JGH00K0MTZ"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());
    
      gtag('config', 'G-JGH00K0MTZ');
    </script> -->
		
	<!-- Add google analytics code rise 2022 -->
	<!-- Global site tag (gtag.js) - Google Analytics -->
...
?>
	<section id="content">
      <div class=" img-responsive img-fluid "> 
				...
				<img style="" class="img-fluid ally_banner w-100" src="<?=$page->ally_banner_image->httpUrl;?>">
			</div>
			<div class="img-responsive  mobile" >
				<img style="padding-top: 5rem;"  class="img-fluid w-100"  src="<?=$page->ally_banner_mobile_image->httpUrl;?>" >
			</div>
  </section>
<?php
}
			    ...
			    <div class="section border-top-0 m-0 text1_alignment" style="">
					<div class="container clearfix" style="height:auto;">
					    <div class="">
                        	...
                        	<div class=" hb mb-4 border-bottom-0 text_spacing_sections" >
...
<section class="content google_form_container" id="google_form_id">
    ...
    <div class="container text-center">
        ...
        <iframe src="<?=$page->page_redirection_url;?>?embedded=true"  frameborder="0" marginheight="0" marginwidth="0" >Loading…</iframe>
...
<!-- <section class="mt-1">	
	<div class="[ d-flex justify-content-center ]">
							<a  target="_blank" style="margin-left: 2px; font-weight:bolder ;margin-top:8px ;" class="spread_text">Spread the Word</a>  -->
