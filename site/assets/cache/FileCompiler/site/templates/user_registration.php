...
// 	        	$company_page= wire('pages')->get("name=universal-companies")->child('title='.$company_name);
...
//         	      $sub_users->$email->registration_status="registered";
...
//         		$session->user_type = "company_subuser";
...
<head>
	...
	<form action="" id="main-container" class="[ my-5 px-sm-5 ][ container rounded ]" method="POST">
		...
		<div class="[ my-5 ][ form-group ]">
			...
			<input id="company_name" class="form-control" type="text" name="company_name" placeholder="Company" value="<?=$session->company_name;?>" required>
    ...
    //             console.log(/^(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[^a-zA-Z0-9])(?!.*\s).{8,}$/.test($("#input-password").val()));
            
    //             if (/^(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[^a-zA-Z0-9])(?!.*\s).{8,}$/.test($("#input-password").val())) 
    //             {
    //                 //$("div").text("pass");
    //               // alert("pass");
    //               $("form").submit();
    ...
    //             } else {
    //                  // alert("Please Check If The Password Matches The Given Condition.");
    //                  setDemo("Check Password","Please Check If The Password Matches The Given Condition.");
    //             }
