...
if (!function_exists('hrtime')) {
 require_once(\ProcessWire\wire('files')->compile(\ProcessWire\wire("config")->paths->root . 'site/templates/pdfparser-master/vendor/symfony/polyfill-php73'.'/Php73.php',array('includes'=>true,'namespace'=>true,'modules'=>true,'skipIfNamespace'=>true)));
