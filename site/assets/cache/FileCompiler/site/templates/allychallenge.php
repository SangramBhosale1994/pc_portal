				    ...
				    <?php
				        foreach($page->header_menus as $header_menus){
				            ...
				            <li class="nav-item active">
				                ...
				                ?>
        					<a  class="nav-link ( underline-button ) "  target="<?=$target?>" href="<?=$header_menus->page_redirection_url;?>"><?=$header_menus->title;?><?php if($header_menus->title=="Impact Report"){?><sup class="[ bg-danger text-white rounded ml-1 px-2 py-1 ]">NEW!</sup><?php } ?></a>
        					</li>
		...
		<div class="[ row ]">
			<div class="[  col-md-12 ][ pt-3 pb-3 ]">
			    <div class="[ mx-auto py-2 ][ text-center  ](   )">
									<a class="e-widget no-button generic-loader" href="https://gleam.io/ZRTZC/allychallenge" rel="nofollow">#AllyChallenge</a>
					...
					<!--<i class="[ pb-2 ][ register_sign_up fas fa-2x fa-arrow-up ]"></i>-->
					<!--<br>-->
					<!--<strong>LOGIN USING EMAIL/SOCIAL MEDIA ACCOUNT</strong>-->
					<!-- <h2 class="text-center">Registrations begin on June 13<br>#AllyChallenge goes live on June 21</h2> -->
					<!--<h2 class="text-center">#AllyChallenge goes live on June 21</h2>-->
				</div>
		...
		<div>
			...
			<div style="margin:auto; width:100%; height:18rem; border:2px solid rgb(66,139,202); overflow-y: scroll; padding-top:0px !important;" class="[ p-md-2 pt-md-none ][ tab-content ]" id="myTabContent">
				<div class="[ tab-pane fade show active ][ text-center ]" id="individual-panel" role="tabpanel" aria-labelledby="individual-tab">
					<table class="table">
					    <h3 class="leaderboard_h2">The #AllyChallenge has now ended</h3>
						<!-- <thead>
...
?>
 ...
 <!--           <div class="[ p-5 ][ align-self-center ][ text-center ]">-->
	...
	<section id="content ">
            <div id="queer_relief" class=" img-responsive img-fluid "> 
			
				<img style="" class="img-fluid ally_banner" src="<?=$page->covid_19_banner->httpUrl;?>">
			</div>
			<div id="queer_relief_mobile" class="img-responsive  mobile" >
