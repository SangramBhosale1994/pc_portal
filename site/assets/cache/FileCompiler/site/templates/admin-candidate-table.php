...
?>
					...
					<div class="card shadow mb-4">
						<div class="[ card-header ][ py-3 ][ d-flex flex-row justify-content-between ]">
                         <!-- <label class="btn btn-outline-primary"><input id='select_all_checkbox' class='select_all_candidate_checkbox' type='checkbox' style="padding-top:0.5rem;"> Select All</label> -->
                            ...
                            <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                <a class="dropdown-item" id="multi_active_button" href="#">Active</a>
                                <a class="dropdown-item" id="multi_inactive_button" href="#">Inactive</a>
                                <a class="dropdown-item" id="multi_lgbt_confirm_button" href="#">LGBT+ Confirm</a>
                                <a class="dropdown-item" id="multi_lgbt_reject_button" href="#">LGBT+ Reject</a>
                            </div>
                            </div> -->
                            ...
                            <!-- <a href="<?=$pages->get("name=send-jobs-mail-candidates")->httpUrl?>"> -->
                            <!-- <form id="send_jobs_mail_container_form" class="[  ][  rounded tab-content ][ needs-validation ]" action="" method="POST" enctype="multipart/form-data" > -->
                                <button id="send_jobs_candidate_button" class="[ btn btn-primary ]( selected-action-button )" type="button" >Send Jobs</button>
                            <!-- </form> -->
                            <!-- </a> -->
                                        ...
                                        <div class="d-flex">
                                            <div class="col-md-8">
                                                <div class="[  ][ form-group ]">
                                                    ...
                                                    <input id="candidate_status" name="candidate_status" type="text" class="form-control tagator" value="" data-tagator-show-all-options-on-focus="true" data-tagator-autocomplete="['<?=$candidate_status_data?>']" style="padding: 2px 12px;">
                                                    
                                                </div>
                                            </div>
                                            <div class="col-md-6" style="margin-top:2rem;">
                                                <button id="btn_candidate_filter" name="btn_candidate_filter" class="[ btn btn-primary ]( selected-action-button )" style="padding: 3px 19px;">Apply Filters</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>  
                        ...
                        <div class="[ card-header ][ py-3 ][ d-flex flex-row justify-content-center ]">
                            <a href="<?=$pages->get("name=candidate-resume-save")->httpUrl?>"><button id="read_resumes_button" class="[ btn btn-primary ]( selected-action-button )" type="button">Read Resumes</button></a>
                        </div>
					</div>
    ...
    <!-- MODAl : Send New Jobs to Candidates -->
    <div class="modal fade" id="send-job-candidate-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLabel">Send New Jobs To Candidates</h5>
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
						<span aria-hidden="true">&times;</span>
					</button>
				</div>
				 <form id="send_jobs_mail_container_form" class="[  ][  rounded tab-content ][ needs-validation ]" action="<?=$pages->get("name=send-jobs-mail-candidates")->httpUrl?>" method="POST" enctype="multipart/form-data" >
				    <div id="" class="modal-body">
				    	<div class="container">
                        <div class="row">
                			    <div class="col-md-6">
                            ...
                            <div class="row">
                			    <div class="col-md-6">
                			        <div class="[  ][ form-group ]">
                                        <?php
                                            $jobs_array=array();
                                            foreach($pages->get("name=jobs")->children("verification=verified,active_status=active,limit=10") as $single_job){
                                                if($single_job->job_publish_shedule!=""){
                                                    if($single_job->job_publish_shedule>time()){
                                                        continue;
                                                    }
                                                }
                                                // $single_job->title="aaa'aaa";
                                                // echo $single_job->title;
                                                // echo "+++++++";
                                                // echo addslashes("aaa'aaa");
                                                // echo "----";
                                                $jobs_array[]=addslashes($single_job->title);
                                                // echo addslashes("$single_job->title");
                                                // echo "///";
                                                // $jobs_array[]=str_replace("'","\'",$single_job->title);
                                                $jobs_array[]=str_replace("&amp;#039;","&",$single_job->title);
                                                $jobs_array[]=str_replace("&#039;","&",$single_job->title);
                                                // print_r($jobs_array);
                                                // echo "------";
                                            ...
                                            // echo $jobs_data;
                                        ?>
                                        <label for="jobs_to_candidate">Jobs </label>
    				...
    				<div class="modal-footer justify-content-between">
                        ...
                        <!-- <a href="<?=$pages->get("name=send-jobs-mail-candidates")->httpUrl?>"> -->
    					    <button id="btn_jobs_to_candidate_mail" type="submit" class="[ btn btn-primary ]" >Send Mail</button>
                        <!-- </a> -->
                    </div>
				  </form>
			</div>
    ...
    <!-- MODAL : End Send New Jobs to Candidates -->
	<script>
	   ...
	   //}
        ...
        function job_send_mail(){
            var checkbox_list = document.getElementByClass("candidate_checkbox").value;
        }
    ...
    <script src="https://kit.fontawesome.com/27714a0b3d.js" crossorigin="anonymous"></script>
	<script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-select/1.13.18/js/bootstrap-select.min.js" integrity="sha512-yDlE7vpGDP7o2eftkCiPZ+yuUyEcaBwoJoIhdXv71KZWugFqEphIS3PU60lEkFaz8RxaVsMpSvQxMBaKVwA5xg==" crossorigin="anonymous"></script>
	<!-- Page level custom scripts --><!-- <script type="text/javascript" src="https://code.jquery.com/jquery-3.6.0.min.js"></script> -->
<!-- <script type="text/javascript" src="https://cdn.datatables.net/v/dt/jszip-2.5.0/dt-1.11.3/datatables.min.js"></script>
