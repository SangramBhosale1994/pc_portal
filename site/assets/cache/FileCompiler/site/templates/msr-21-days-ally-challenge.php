...
<head>
	...
	<title>MRA #21DaysAllyChallenge | Pride Circle</title>
	...
	<meta property="og:title" content="MRA 21 Days Ally Challenge | Pride Circle">
	<meta property="og:image" content="<?= $rootpath;?>images/slide-7.jpg">
	<meta property="og:description" content="MRA #21DaysAllyChallenge">
	<meta property="og:url" content="https://www.thepridecircle.com/21daysallychallenge/">

	<meta name="twitter:title" content="MRA 21 Days Ally Challenge | Pride Circle">
	<meta name="twitter:description" content="#21DaysAllyChallenge">
	<meta name="twitter:image" content="<?= $rootpath;?>images/slide-7.jpg">
	<meta name="twitter:card" content="MRA 21DaysAllyChallenge">

	<meta property="og:site_name" content="Pride Circle">
	<meta name="twitter:image:alt" content="MRA 21DaysAllyChallenge">
	<!-- ---------- META TAGS END ---------- -->
	...
	<nav id="navbar" class="[ navbar fixed-top navbar-expand-lg navbar-light bg-white ]">
		...
		<div class="[ container ]">
			<a class=" [ navbar-brand ][ d-sm-inline-block d-md-none ]" href="#">
				...
				<img src="<?=$rootpath?>images/powered-by-msd.png" style="width:78px; height:auto"  alt="">
			</a>
		...
		<img class="[ mr-5 ][ d-none d-md-inline-block ]" src="<?=$rootpath?>images/powered-by-msd.png" style="width:110px; height:auto"  alt="">
	</nav>
		...
		<div id="carouselExampleIndicators" class="[ carousel slide ]" data-ride="carousel">
			<div class="carousel-inner">
				<div class="carousel-item active">
					<img class="d-block w-100" src="<?= $rootpath;?>images/msr-slide-1.PNG" alt="First slide">
				</div>
	...
	<div class="[ container ]">
		<div class="[ row ]">
			<div class="[ offset-md-2 col-md-8 ][ pt-3 pb-3 ]">
				...
				<a class="e-widget no-button" href="https://gleam.io/h42RX/mra-21daysallychallenge" rel="nofollow">MRA: #21DaysAllyChallenge</a>
...
//print_r($participating_companies_array);
	...
	<div class="[ mt-3 py-5 ][ container ]">
		...
		<div class="[ mx-md-5 px-md-5 ][ d-md-flex justify-content-md-around ]">
			<div class="[ p-5 ][ align-self-center ][ text-center ]">
				<img class="[ img-fluid ]" style="max-width:220px; height:auto" src="<?= $rootpath;?>images/mra-logo.jpg" alt="">
			</div>
		</div>
