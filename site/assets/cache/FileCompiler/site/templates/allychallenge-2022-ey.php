...
<head>
	...
	<meta property="og:title" content="EY #AllyChallenge 2022">
	<meta property="og:image" content="<?=$page->og_image->httpUrl;?>">
	<!-- <meta property="og:description" content="<?=$page->og_description?>"> -->
	<!-- <meta property="og:url" content="<?=$page->httpUrl?>"> -->
	<meta property="og:url" content="https://gleam.io/3SZKZ/ey-allychallenge-2022"/>

	<meta name="twitter:title" content="<?=$page->title?> | Pride Circle">
	<meta name="twitter:description" content="<?=$page->og_description?>">
	<meta name="twitter:image" content="<?=$page->og_image->httpUrl;?>">
	...
	<nav id="navbar" class="[ navbar fixed-top navbar-expand-lg navbar-light bg-white ]">
        ...
        <!--        	</strong>-->
    			...
    			<a class=" [ navbar-brand mobile_2nd_logo ][ d-sm-inline-block d-md-none ]" href="#">
    				<img class="navbar_img" src="<?=$page->header_logo2->httpUrl;?>" style="width:50px; height:auto"  alt="">
     ...
     <!--                   </ul>-->
		...
		<?php
			if($page->header_logo2!=""){
		?>
		<img id="navbar-md-logo" class="[  header_logo_two ][ d-none d-md-inline-block ]" src="<?=$page->header_logo2->httpUrl;?>" style="width:50px; height:auto"  alt="">
		<?php
			}
		?>
	</nav>
			    ...
			    <div class="section border-top-0 m-0 text1_alignment" style="">
					<div class="container clearfix">
					    <div class="row col-mb-50">
                        	...
                        	<div class="text-md-left hb mb-4 border-bottom-0 text_spacing_sections" style="font-size:0.875rem;">
    		...
    		<div class="[ mx-md-5 px-md-5  ][ row ]">
    			...
    			<div class="[ col-md-4 ][ text-center ]">
    			    ...
    			    ?>
                    	...
                    	<a class="[ pb-2 ]( underline-button ) register_faq_tooltip"   data-toggle="tooltip" data-placement="bottom" title="Coming soon!" style="cursor:pointer;">FAQ</a>
                    <?php
    			        }
    			    ?>
    			</div>
		...
		<div class="[ row ]">
			<div class="[  col-md-12 ][ pt-3 pb-3 ]">
			    ...
			    <div class="[ mx-auto py-2 ][ text-center  ](   )">
                    ...
                    <!-- <a class="e-widget no-button generic-loader" href="https://gleam.io/ZRTZC/allychallenge" rel="nofollow">#AllyChallenge2022</a> 
                     <script type="text/javascript" src="https://widget.gleamjs.io/e.js" async="true"></script>  -->
								
								<a class="e-widget no-button generic-loader" href="https://gleam.io/3SZKZ/ey-allychallenge-2022" rel="nofollow">EY #AllyChallenge 2022</a>
								<script type="text/javascript" src="https://widget.gleamjs.io/e.js" async="true"></script>			 
								<div class="[ mx-auto py-2 ][ text-center text-white ]( sign-up-indicator )"> 
							<!-- <h2 class="pt-5 pb-4">Coming Soon!</h2> -->
    					<i class="[ pb-2 ][ fas fa-2x fa-arrow-up ]"></i>
    					<br> 
							<strong>REGISTER/ LOGIN USING EY EMAIL ID</strong>
    					<!-- <strong>REGISTER/ LOGIN USING EMAIL/ SOCIAL MEDIA ACCOUNT</strong> -->
...
<?php if($page->leaderboard_title!=""){ ?>
	<div id="leaderboard" class="[ pt-5 ][ container ]">
		...
		<div class="[ text-center ]">
			...
			<div>
				<!-- <strong class="[ px-3 py-2 ][ bg-danger rounded ][ text-white ]">Coming Soon</strong> -->
		...
		<div>
			...
			<div style="margin:auto; width:100%; height:18rem; border:2px solid rgb(66,139,202); overflow-y: scroll; padding-top:0px !important;" class="[ p-md-2 pt-md-none ][ tab-content ]" id="myTabContent">
				<div class="[ tab-pane fade show active ][ text-center ]" id="individual-panel" role="tabpanel" aria-labelledby="individual-tab">
					<table class="table">
					    <!-- <h2 class="leaderboard_h2">Coming Soon!</h2> -->
						<thead>
						...
						<tbody>
							<?php
								$individual_leaderboard_array = $page->child("name=allychallenge-2022-ey-leaderboard-update")->ally_challenge_leaderboard_individual;
							...
							<tr>
								...
								<td><?=ucwords(strtolower($individual_leader["contestant_name"])) ?></td>
				...
				<!-- <div class="[ tab-pane fade ][ text-center ]" id="profile" role="tabpanel" aria-labelledby="profile-tab">
					<table class="table">
						...
						<!--<tbody>
						<?php
								$group_leaderboard_array = $page->child("template=ally_challenge_update_leaderboard")->ally_challenge_leaderboard_group;
    	        ...
    	        foreach($page->partners_logo as $partners_logo){
    	           ...
    	           // echo $partners_logo->logo_images->first()->httpUrl;
        			...
        			<div class="[ pl-5 pr-5 ][ align-self-center ][ text-center ]">
							<a target="_blank" href="<?=$partners->description;?>"><img class="[ img-fluid ]" style="max-width:150px; height:auto" 
        				src="<?=$partners->httpUrl;?>" alt=""></a>
        			</div>
        		<?php
        		    $logo_counter++;
        		    if($logo_counter%4==0){
 ...
 <!--           <div class="[ p-5 ][ align-self-center ][ text-center ]">-->
	...
	<section id="content ">
      ...
      <div class="[  mx-md-5 px-md-5 ][  justify-content-md-center covid_logo ]">
    	    ...
    	    ?>
    			<div class="[ pl-5 pr-5 ][ align-self-center ][ text-center ]">
    				<a target="_blank" href="<?=$covid_19_logos->description;?>"><img class="[ img-fluid ]" style="max-width:150px; height:auto" 
    				src="<?=$covid_19_logos->httpUrl;?>" alt=""></a>
    			</div>
    		<?php
		...
		<div class="[ pb-4 ][ container-fluid  ]">
			<div class="[ row pt-3 ]">
			    ...
			    $counter=1;
                  ...
                  if(count($page->footer_links)>1){
                    $width_style="max-width: 33.333333% !important;";
                    
                  }
                  elseif(count($page->footer_links)>2){
                    $width_style="max-width: 33.333333% !important;";
                    $style=""; 
                  }
                  else{
                    $width_style="max-width:72rem !important;margin:auto;";
										// $style="margin-left:0"; 
                  }
			    ?>
			    <div class="[ <?=$style;?> col-md-4 ][ text-center ] footer_links_web" style="<?=$width_style;?>">
					...
					<div class="[ <?=$style;?> col-md-4 ][ text-center ] footer_links_mob" >
			        <!--<a href="<?=$footer_links->footer_files->httpUrl;?>" target="_blank" class="[ text-secondary ]" title=""><?=$footer_links->title?></a>-->
						<a href="<?=$footer_url;?>" target="_blank" class="[ text-secondary ]" title="" download><?=$footer_links->title?></a>
					</div>
			    <?php
