...
{
 require_once(\ProcessWire\wire('files')->compile('razorpay-php'.'/libs/Requests-1.7.0/library/Requests.php',array('includes'=>true,'namespace'=>true,'modules'=>true,'skipIfNamespace'=>true)));
}
