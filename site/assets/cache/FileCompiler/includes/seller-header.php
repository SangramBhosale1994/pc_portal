...
// 	  $company_page= $pages->get("name=seller-profiles")->child("title=".$session->company_name);
...
// 	}
		...
		$company_page= $pages->get("name=seller-profiles")->child("seller_email=".$session->email);
	//echo $company_page->id;
	if($company_page->verification=="unverified"){
	    	$session->redirect($pages->get("name=universe")->httpUrl);
	}
...
// //   document.content-wrapper.style.backgroundColor = "rgba(0,0,0,0.4)";
...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion " id="accordionSidebar">
			...
			<a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
				...
				<div class="sidebar-brand-text mx-3 sidebar_to_text" style=""><b><?=$session->name."</b><br>".$session->email."</b><br>"?></span></div>
   ...
   <!--                 </ul>-->
    ...
    <!--            </div>-->
    <!--        </li>-->
			<?php if($session->user_type == "company_seller"){
			?>
			<!--<li class="nav-item active">-->
		 ...
		 <!--   	<hr class="sidebar-divider">-->
			...
			<?php
			 ...
			 //  $company_page= $pages->get("name=referral-profiles")->child("title=".$session->company_name);
			...
			?>
			<!--<li class="nav-item active">-->
			<!--	<a class="nav-link" href="<?=$config->urls->httpRoot ?>universe/referral-dashboard/rise-sponsorship/">-->
			<!--		<i class="fas fa-fw fa-briefcase"></i>-->
			...
			<!--<li class="nav-item active">-->
			<!--	<a class="nav-link" href="<?=$config->urls->httpRoot ?>universe/referral-dashboard/rise-sponsorship/" style="margin-left: 1rem;padding: 0px 0.5rem 0.5rem 0rem;">-->
			<!--		<i class="fas fa-fw fa-briefcase"></i>-->
			<!--		<span>RISE 2021 (May)</span></a>-->
			<!--</li>-->
   ...
   <!--             </a>-->
		...
		<div id="content-wrapper" class="d-flex flex-column content_dashboard" style="">
            ...
            <img src="<?=$pages->get("name=seller-header")->banner_image->httpUrl?>" class="[ img-fluid ]( mobile-hide )" alt="Pride Circle Banner Image" style="width:100%;">
            <img src="<?=$pages->get("name=seller-header")->Banner_image_mobile->httpUrl?>" class="[ img-fluid ]( mobile-show )" alt="Pride Circle Banner Image" style="width:100%;">
            </div>
				<!-- Topbar -->
						...
						<!--<div class="topbar-divider d-none d-sm-block"></div>-->
                            <?php 
                                if($session->user_type == 'company_referrer'){
                                    $company_user_type = "Company Referrer";
                                }
                                else{
