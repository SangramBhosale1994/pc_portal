...
<body id="page-top">
	<?php
		...
		$admin_array= [
			"naina@thepridecircle.com" => "@Naina1854#",
			"ram@thepridecircle.com" => "@Ram9325#"
		];

		if(isset($_POST['admin_email'])){
			if(isset($admin_array[$_POST['admin_email']]) && $admin_array[$_POST['admin_email']] == $_POST['admin_password']){
				$session->admin_email = $_POST['admin_email'];
				$session->admin_candidate_table_columns= [
					"id",
					"custom_full_name",
					"pronoun",
					"identify_as",
		...
		<div class="row">
			...
			<form class="[ offset-md-4 col-md-4 ][ p-2 ][ rounded border-dark ]" action="<?=$page->url?>" method="POST" accept-charset="utf-8">
				<div class="[ form-group ]">
					...
					<input id="admin_email" class="form-control" type="text" name="admin_email" placeholder="Login ID">
				</div>
	...
	<div id="wrapper">
		...
		<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
			...
			<li class="nav-item active">
				<a class="nav-link" href="<?=$config->urls->httpRoot ?>pc-admin/">
					<i class="fas fa-fw fa-tachometer-alt"></i>
					<span>Dashboard</span></a>
			</li>

			<li class="nav-item active">
				<a class="nav-link" href="<?=$config->urls->httpRoot ?>pc-admin/candidate-list/">
					<i class="fas fa-fw fa-table"></i>
					<span>Manage Table</span></a>
			</li>

			<li class="nav-item active">
				<a class="nav-link" href="<?=$config->urls->httpRoot ?>pc-admin/export-table/">
					...
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item dropdown no-arrow">
							<a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
								<span class="mr-2 d-none d-lg-inline text-gray-600 small"><?=$session->admin_email?></span>
