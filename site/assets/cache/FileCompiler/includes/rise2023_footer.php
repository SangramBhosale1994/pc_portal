					...
					<div class="row col-mb-30 justify-content-center">
						...
						<div class="order-lg-1 col-lg-4 ">
						    <div class="d-flex justify-content-center justify-content-lg-start">
							            <a target="_blank" href="<?=$pages->get("name=footer2023")->heading2;?>" class="social-icon si-small si-borderless si-linkedin">
											<i class="white-color icon-linkedin" style="color: #fff;font-size: 1rem;"></i>
											<i class="icon-linkedin" style="font-size: 1rem;"></i>
										</a>
										<a target="_blank" href="<?=$pages->get("name=footer2023")->heading3;?>" class="social-icon si-small si-borderless si-instagram">
											<i class="white-color icon-instagram" style="color: #fff;font-size: 1rem;"></i>
											<i class="icon-instagram" style="font-size: 1rem;"></i>
										</a>
		                                <a target="_blank" href="<?=$pages->get("name=footer2023")->heading4;?>" class="social-icon si-small si-borderless si-facebook">
											<i class="white-color icon-facebook" style="color: #fff;font-size: 1rem;"></i>
											<i class="icon-facebook" style="font-size: 1rem;"></i>
										</a>
		                                <a target="_blank" href="<?=$pages->get("name=footer2023")->heading5;?>" class="social-icon si-small si-borderless si-gplus">
										...
										<a target="_blank" href="<?=$pages->get("name=footer2023")->heading6;?>" class="social-icon si-small si-borderless si-twitter">
											<i class="icon-twitter" style="color: #fff;font-size: 1rem;"></i>
											<i class="icon-twitter" style="font-size: 1rem;"></i>
										</a>
										<a target="_blank"  href="<?=$pages->get("name=footer2023")->heading7;?>" class="social-icon si-small si-borderless  si-tripadvisor">
						...
						<div class="order-lg-2 copyright-links col-lg-3 text-center text-lg-right">
							<a href="tel:<?=$pages->get("name=footer2023")->ally_social_title_color;?>"><i style="margin-right: 0.3rem" class="icon-line-phone-call"></i><?=$pages->get("name=footer2023")->ally_social_title_color;?></a>
								<br>
							<a href="mailto:<?=$pages->get("name=footer2023")->heading8;?>"><i class="icon-envelope2" style="margin-right: 0.3rem"></i><?=$pages->get("name=footer2023")->heading8;?></a>
						</div>

						<div class="order-lg-0 col-lg-5 text-center text-lg-left">
						<div class="copyright-links"><a href="<?=$pages->get("name=privacy-policy2023")->httpUrl;?>" ><?=$pages->get("name=privacy-policy2023")->title;?></a> / <a href="<?=$pages->get("name=disclaimer2023")->httpUrl;?>"><?=$pages->get("name=disclaimer2023")->title;?></a></div>
