...
// include_once(\ProcessWire\wire('files')->compile(FCPATH.'PHPMailer/src/Exception.php',array('includes'=>true,'namespace'=>true,'modules'=>true,'skipIfNamespace'=>true)));
 ...
 require_once(\ProcessWire\wire('files')->compile('PHPMailer/src/Exception.php',array('includes'=>true,'namespace'=>true,'modules'=>true,'skipIfNamespace'=>true)));
 require_once(\ProcessWire\wire('files')->compile('PHPMailer/src/PHPMailer.php',array('includes'=>true,'namespace'=>true,'modules'=>true,'skipIfNamespace'=>true)));
 require_once(\ProcessWire\wire('files')->compile('PHPMailer/src/SMTP.php',array('includes'=>true,'namespace'=>true,'modules'=>true,'skipIfNamespace'=>true)));
