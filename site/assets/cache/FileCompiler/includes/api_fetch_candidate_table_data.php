...
// 	}
// 	else{}
	elseif(isset($_POST['filter_form'])){
...
//     print_r($filter_selector);
 ...
 //$to_return->candidate_data=array();
		$all_candidates_array=$pages->get("name=candidates")->children($filter_selector.",sort=published");
   ...
   foreach ($all_candidates_array as $candidate_page) {
       ...
       if($candidate_page->current_employer!=""){
		...
		$candidate_data->serial_number=$serial_counter;
			$serial_counter++;
