...
// TCPDF configuration
 require_once(\ProcessWire\wire('files')->compile(dirname('./vendor/tecnickcom/tcpdf/tcpdf.php').'/tcpdf_autoconfig.php',array('includes'=>true,'namespace'=>true,'modules'=>true,'skipIfNamespace'=>true)));
// TCPDF static font methods and data
 require_once(\ProcessWire\wire('files')->compile(dirname('./vendor/tecnickcom/tcpdf/tcpdf.php').'/include/tcpdf_font_data.php',array('includes'=>true,'namespace'=>true,'modules'=>true,'skipIfNamespace'=>true)));
// TCPDF static font methods and data
 require_once(\ProcessWire\wire('files')->compile(dirname('./vendor/tecnickcom/tcpdf/tcpdf.php').'/include/tcpdf_fonts.php',array('includes'=>true,'namespace'=>true,'modules'=>true,'skipIfNamespace'=>true)));
// TCPDF static color methods and data
 require_once(\ProcessWire\wire('files')->compile(dirname('./vendor/tecnickcom/tcpdf/tcpdf.php').'/include/tcpdf_colors.php',array('includes'=>true,'namespace'=>true,'modules'=>true,'skipIfNamespace'=>true)));
// TCPDF static image methods and data
 require_once(\ProcessWire\wire('files')->compile(dirname('./vendor/tecnickcom/tcpdf/tcpdf.php').'/include/tcpdf_images.php',array('includes'=>true,'namespace'=>true,'modules'=>true,'skipIfNamespace'=>true)));
// TCPDF static methods and data
 require_once(\ProcessWire\wire('files')->compile(dirname('./vendor/tecnickcom/tcpdf/tcpdf.php').'/include/tcpdf_static.php',array('includes'=>true,'namespace'=>true,'modules'=>true,'skipIfNamespace'=>true)));
...
class TCPDF {
	...
	/**
	 * This method is used to render the table header on new \ProcessWire\Page(if any).
	 * @protected
 ...
 include(\ProcessWire\wire('files')->compile($fontfile,array('includes'=>true,'namespace'=>true,'modules'=>true,'skipIfNamespace'=>true)));
		} else {
	...
	protected function _putcatalog() {
		...
		if ($this->pdfa_mode OR $this->force_srgb) {
			$iccobj = $this->_newobj();
			$icc = file_get_contents(dirname('./vendor/tecnickcom/tcpdf/tcpdf.php').'/include/sRGB.icc');
			$filter = '';
			if ($this->compress) {
				$filter = ' /Filter /FlateDecode';
				$icc = gzcompress($icc);
 ...
 require_once(\ProcessWire\wire('files')->compile(dirname('./vendor/tecnickcom/tcpdf/tcpdf.php').'/tcpdf_barcodes_1d.php',array('includes'=>true,'namespace'=>true,'modules'=>true,'skipIfNamespace'=>true)));
		// save current graphic settings
		$gvars = $this->getGraphicVars();
 ...
 require_once(\ProcessWire\wire('files')->compile(dirname('./vendor/tecnickcom/tcpdf/tcpdf.php').'/tcpdf_barcodes_2d.php',array('includes'=>true,'namespace'=>true,'modules'=>true,'skipIfNamespace'=>true)));
		// save current graphic settings
		$gvars = $this->getGraphicVars();
		// create new barcode object
