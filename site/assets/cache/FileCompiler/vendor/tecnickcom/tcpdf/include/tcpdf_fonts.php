...
class TCPDF_FONTS {
			...
			if ($fmetric['type'] == 'cidfont0') {
				...
				switch ($fonttype) {
					case 'CID0JP': {
						...
						$pfile .= 'include(dirname('./vendor/tecnickcom/tcpdf/include/tcpdf_fonts.php').\'/uni2cid_aj16.php\');'."\n";
						break;
					}
					case 'CID0KR': {
						$pfile .= '// Korean'."\n";
						...
						$pfile .= 'include(dirname('./vendor/tecnickcom/tcpdf/include/tcpdf_fonts.php').\'/uni2cid_ak12.php\');'."\n";
						break;
					}
					case 'CID0CS': {
						...
						$pfile .= 'include(dirname('./vendor/tecnickcom/tcpdf/include/tcpdf_fonts.php').\'/uni2cid_ag15.php\');'."\n";
						break;
					}
					case 'CID0CT':
					default: {
	...
	public static function _getfontpath() {
		if (!defined('K_PATH_FONTS') AND is_dir($fdir = realpath(dirname('./vendor/tecnickcom/tcpdf/include/tcpdf_fonts.php').'/../fonts'))) {
			if (substr($fdir, -1) != '/') {
				$fdir .= '/';
			}
