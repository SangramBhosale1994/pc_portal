...
<body class="stretched">
	<!-- Document Wrapper
	============================================= -->
	<script>let total_word_count=0;</script>
				  ...
				  <!--         <div id="primary-menu-trigger">-->
                    ...
                    <li class="menu-item">
                      <a class="menu-link" href="#booklaunch"><div>Pre-Order</div></a>
    								...
    								<li class="menu-item mega-menu">
    									<a class="menu-link" href="#testimonal"><div>Testimonial</div></a>
        ...
        <section id="content" style="padding: 0px 0 !important;";>
            <div class="content-wrap py-0">
                <div class="container">
                    ...
                    <br/>
                    <center><a target="_blank" href="https://registrations.ficci.com/ficpri/online-registrationv.asp" class="button button-desc button-3d button-rounded button-green center">Register Here</a></center>
                </div>
            </div>
   ...
   <!--     </section>-->
        ...
        -->
        <section id="wordcloud"  class="border border-dark">
            <br><br>
            <div class="heading-block mb-4 border-bottom-0" >
							<!--<h1 style="text-transform:uppercase; font-weight:bold !important;" class="font-weight-normal letter note mb-0" align="center">ALLIES</h1>-->
                    ...
                    <div class="container clearfix">
						...
						<div class="row col-mb-50">
							...
							<div class="text-md-left hb mb-4 border-bottom-0 text_alignment ">
								...
								<p class="p_description " ><?=$page->text_description?></p>
            ...
            <div class="d-flex justify-content-center p-5">
                    ...
                    <span class="badge badge-primary" ><h4 id="total_word_count_div">Total Pledges: </h4></span>
                </div>       
            <div class="d-flex justify-content-center">
                ...
                ?> 
                    <div class="text-center" id="word_cloud_form">
                        ...
                        <form id="add_value" method="post">
                            <input type="text" class="form-control" name="word_cloud_pincode" id="word_cloud_pincode" placeholder="Your pin/zip code"  required><br><br>
			...
			<div class="content-wrap" id="testimonal">
				<div class="container clearfix">
    					<div class="d-flex justify-content-center" style="" >
    					        <h2 style="text-transform:uppercase;"><b>Testimonial</b></h2>
    					</div>
 ...
 <footer id="footer" class="dark" style="     margin-top: 0px;"  >
	...
	$(document).ready(function () {
        ...
        checkInput=function(input, words) {
        ...
        // for(key in word_cloud_data_obj)
        // {
        //     let temp=word_cloud_data_obj[key];
        //     delete word_cloud_data_obj[key];
        //     temp=stripslashes(temp);
        //     key=addslashes(key)
        //     word_cloud_data_obj[key.toString()]=temp;
        // }
        ...
        $("#add_value").submit(function (event) {
                ...
                let word_to_exclude=<?=$page->word_to_exclude?>;
                if(!checkInput(word,word_to_exclude)){
                    ...
                    $.ajax({
                          ...
                          data: {'word':word,'pincode':pincode},
                          //datatype:"text",
...
<script>
//name="word_cloud_button" console.log("margin")
