...
error_reporting(E_ERROR);
	...
	foreach ($candidate_page_array as $key => $value) {
		...
		// if(isset($experience_array[addslashes($value->experience_years)+0])){
		// 	$experience_array[(int)addslashes($value->experience_years)+0]++;
		// }
		// else{
		// 	$experience_array[(int)addslashes($value->experience_years)+0] = 1;
		// }
		if(isset($experience_array[(int)addslashes($value->experience_years)])){
			$experience_array[(int)addslashes($value->experience_years)]++;
		}
		else{
			$experience_array[(int)addslashes($value->experience_years)] = 1;
		}
...
?>
				...
				<div class=" mb-4">
				<h1 class="h2 mb-0 text-gray-800 text-center">Dashboard</h1>
			</div>
				...
				<div class="card-body">
					...
					<div class="row ">
						...
						<div class="col-xl-3 col-md-6 mb-4">
							<a href="<?=$pages->get('name=admin-candidate-table')->url?>" class="card border-left-primary shadow h-100 py-2">
								<div class="card-body">
						...
						<!-- Earnings (Monthly) Card Example -->
						<div class="col-xl-3 col-md-6 mb-4">
							<a href="<?=$pages->get('name=admin-candidate-table')->url?>" class="card border-left-success shadow h-100 py-2">
								<div class="card-body">
									<div class="row no-gutters align-items-center">
										<div class="col mr-2">
