<?php
	...
	*/
	...
	foreach($pages->get("name=vip-attendee,status<" . Page::statusTrash)->children("sort=-published,verification=verified,status<" . Page::statusTrash) as $ticketing_vip_page) {
	...
	*/
	...
	foreach($pages->get("name=attendee,status<" . Page::statusTrash)->children("sort=-published,status<" . Page::statusTrash) as $ticketing_vip_page) {
            $temp_object=new stdClass();
            $temp_object->id=$ticketing_vip_page->serial_id;
            $temp_object->first_name=$ticketing_vip_page->first_name;
            $temp_object->last_name=$ticketing_vip_page->last_name;
