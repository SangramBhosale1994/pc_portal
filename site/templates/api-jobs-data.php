...
// echo "****";
 ...
 $all_jobs_array_without_filter=wire('pages')->get("name=jobs")->children("sort=-published,verification=verified,active_status=active,".$filter_selector);
//  $all_jobs_array=wire('pages')->get("name=jobs")->children("sort=-published,".$filter_selector);
 $all_jobs_array=wire('pages')->get("name=jobs")->children("sort=-published,verification=verified,active_status=active,".$start_limit_selector);
...
// echo $company_profile_present;
			if($company_profile_present=="true"){
				$job_data->company_profile_link=wire('pages')->get('name=company=profile')->httpUrl."?name=".$job_page->company_name;
			}
			else{
