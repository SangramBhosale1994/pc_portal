								...
								<div id="filter_controls">
									<form id="candidate_filter_form" class="[  ][  rounded tab-content ][ needs-validation ]" action="" method="POST" enctype="multipart/form-data" >
										<div class="row" style="justify-content: flex-start;margin-bottom: 1rem;">
											<div class="d-flex">
												<div class="col-md-12">
													<button id="candidate_status_btn_filters_all"  class="[ btn btn-outline-primary ]( selected-action-button )" value=""  type="button" style="margin-right:1rem;">All Candidates</button>
													<button id="candidate_status_btn_filters_shortlisted" class="[ btn btn-outline-primary ]( selected-action-button )"  value="CV Shortlisted"  type="button" style="margin-right:1rem;">CV Shorlisted</button>
													<button id="candidate_status_btn_filters_notviewed"  class="[ btn btn-outline-primary ]( selected-action-button )" value="Not Viewed"  type="button" style="margin-right:1rem;">Not Viewed</button>
												</div>
											</div>
										</div>
