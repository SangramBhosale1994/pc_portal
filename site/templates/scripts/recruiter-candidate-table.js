...
// 			}
	...
	$("#btn_applicant_candidate_filter").on('click', function (e) {
		...
		// let candidate_status_filter=$("#candidate_filter_form").val();
		// console.log(candidate_status_filter);
	...
	$("#candidate_status_btn_filters_all").click(function() {
		...
		// candidate_text.html('New Option Text');
		candidate_filter_form_details='[{"name":"applicants_candidate_status_filter","value":""}]';
		console.log(candidate_filter_form_details);
		$('#applicants_candidate_status_filter').prop('selectedIndex', 0);
		$("#applicants_candidate_status_filter_div").show();
		$(this).css({
...
$("#candidate_status_btn_filters_shortlisted").click(function() {
		...
		console.log(value);
		candidate_tab_filter=value;
		candidate_filter_form_details='[{"name":"applicants_candidate_status_filter","value":"CV Shortlisted"}]';
		console.log(candidate_filter_form_details);
		$("#applicants_candidate_status_filter_div").hide();
		$(this).css({
			"background-color": "#4e73df !important",
			"color": "#000"
		});
...
$("#candidate_status_btn_filters_notviewed").click(function() {
		...
		console.log(value);
		candidate_tab_filter=value;
		candidate_filter_form_details='[{"name":"applicants_candidate_status_filter","value":"Not Viewed"}]';
		console.log(candidate_filter_form_details);
		$("#applicants_candidate_status_filter_div").hide();
		$(this).css({
