...
/**Job data fetching api  */
    function fetch_jobs_data(start,search_form_details,quick_search_details,company_id){
...
//   dataType : 'text',
    ...
    fetch_jobs_data('0',search_form_details,quick_search_details,company_id);
    // total_cards=165;
                ...
                //// console.log(value_start_and_pagination);
                    if(value_start_and_pagination!=1){
                       ...
                       // console.log(start);
                        ...
                        fetch_jobs_data(start,search_form_details,quick_search_details,company_id);
                        // showPage(parseInt(value_start_and_pagination-1));
