...
$(document).ready(function () {
	...
	$('#personal_form_container').on('keyup keypress', function (e) {
   ...
   /*Code by Amruta jagtap 2021-04-13 candidate form in 3steps. each form validation*/
...
console.log("sub");
	/* Validation on Button Click and Tab Navigation */
	$("#main-container-old").on('submit', function (e) {
    	e.preventDefault();
		e.stopPropagation();
