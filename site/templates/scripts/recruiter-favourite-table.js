...
console.log(result)
		...
		/* Ajax to get Data from the admin table data api */
			function api_fetch_candidate_table_data(requested_columns_array_json){
				...
				// let candidate_filter_form_data = $("#recruiter_candidate_status").val();
				...
				// let candidate_status_tab;
				// let candidate_filter_tab;
				// candidate_filter_tab = "false";
				// candidate_status_tab="";
				// console.log(candidate_filter_btn_data);
				// if(candidate_filter_btn_data !=""){
				// 	candidate_filter_tab = "true";
				// 	candidate_status_tab=candidate_filter_btn_data;
				// }
...
console.log(result)
		...
		$("#candidate_status_btn_filters_all").click(function() {
				...
				console.log($('#recruiter_candidate_status').val());
				console.log("All click");
				// $('#recruiter_candidate_status').text('All Candidates');
