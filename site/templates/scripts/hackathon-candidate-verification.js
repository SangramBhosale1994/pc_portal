$(document).ready(function() {
	...
	console.log(homepath);
			...
			console.log(candidate_filter);
					...
					$.ajax({
							url : homepath+'api/hackathon-candidate-verification/',
		...
		console.log(result)
						...
						//	function refresh_datatable(search_filter_data){
							...
							//             "ajax": homepath + "api/fetch-candidate-table-data/",
													...
													ajax: {
														url: homepath + "api/hackathon-candidate-verification/?"+url_parameters,
														type: 'POST',
														data:{
...
console.log(result);
	...
	//  dataType : "text",
		...
		$(document).on("click", ".verify_button", function () {
			/* Array of IDs of profiles to be deleted, converted to JSON */
			let requested_candidate_profile_to_verify = $(this).attr("id").replace("_verify_button", "");
			console.log(requested_candidate_profile_to_verify);
			...
			$.ajax({
					...
					//  dataType: 'text',
					data: {
							"requested_action_to_take": "hackathon_candidate_verify",
							"requested_candidate_profile_to_verify": requested_candidate_profile_to_verify
					},
					beforeSend: function () {
		...
		$(document).on("click", ".unverify_button", function () {
			/* Array of IDs of profiles to be deleted, converted to JSON */
			let requested_candidate_profile_to_unverify = $(this).attr("id").replace("_unverify_button", "");
			console.log(requested_candidate_profile_to_unverify);
			...
			$.ajax({
					...
					//  dataType: 'text',
					data: {
							"requested_action_to_take": "hackathon_candidate_unverify",
							"requested_candidate_profile_to_unverify": requested_candidate_profile_to_unverify
					},
					beforeSend: function () {
							$(this).attr('disabled', 'true');
							$(this).html('Locking...');
