...
if (isset($_POST['btn-send'])) {
  ...
  $offerings_foundational = $_POST['foundational1'];
  $daily_updates_foundational = $_POST['foundational2'];
  $offerings_intermediate = $_POST['intermediate1'];
  $daily_updates_intermediate = $_POST['intermediate2'];
  ...
  $offerings_foundational = $sanitizer->text($input->post->foundational1);
  $daily_updates_foundational = $sanitizer->text($input->post->foundational2);
  $offerings_intermediate = $sanitizer->text($input->post->intermediate1);
  $daily_updates_intermediate = $sanitizer->text($input->post->intermediate2);
  ...
  $new_profile_page->heading6 = $offerings_foundational;
  $new_profile_page->heading7 = $daily_updates_foundational;
  $new_profile_page->heading8 = $offerings_intermediate;
  $new_profile_page->heading9 = $daily_updates_intermediate;
                                                ...
                                                <div class="modal-body" style="padding: 0.1rem;">
                                                  ...
                                                  <div class="row">
                                                    <div class="col-md-6 col-sm-12 form-group">
                                                      ...
                                                      <input type="tel" id="phone" name="phone"  class="sm-form-control" value="" placeholder="Phone number with country code">
                                                    </div>
                                                  ...
                                                  <div class="form-group">
                                                    ...
                                                    <div style="display: flex;">
                                                      <div style="margin-right: 1rem">
                                                        <input type="radio" id="foundational1-Yes" name="foundational1" value="yes" checked>
                                                        <label for="yes" style="font-weight: 500;">Yes</label>
                                                      </div>
                                                      <div>
                                                        <input type="radio" id="foundational1-No" name="foundational1" value="no">
                                                  ...
                                                  <div class="form-group">
                                                    ...
                                                    <div style="display: flex;">
                                                      <div style="margin-right: 1rem">
                                                        <input type="radio" id="foundational2-Yes" name="foundational2" value="yes" checked>
                                                        <label for="yes" style="font-weight: 500;">Yes</label>
                                                      </div>
                                                      <div>
                                                        <input type="radio" id="foundational2-No" name="foundational2" value="no">
                                                        <label for="no" style="font-weight: 500;">No</label>
                                                      </div>
                                                    </div>
                                                  </div>
                                              ...
                                              <form action="" id="main-container<?= $slider_counter ?>" method="POST" class="mb-1">
                                                <div class="modal-body" style="padding: 0.1rem;">
                                                  ...
                                                  <div class="form-group">
                                                    ...
                                                    <div style="display: flex;">
                                                      <div style="margin-right: 1rem">
                                                        <input type="radio" id="intermediate1-Yes" name="intermediate1" value="yes" checked>
                                                        <label for="yes" style="font-weight: 500;">Yes</label>
                                                      </div>
                                                      <div>
                                                        <input type="radio" id="intermediate1-No" name="intermediate1" value="no">
                                                        <label for="no" style="font-weight: 500;">No</label>
                                                      </div>
                                                    </div>
                                                  </div>
                                                  <div class="form-group">
                                                    ...
                                                    <div style="display: flex;">
                                                      <div style="margin-right: 1rem">
                                                        <input type="radio" id="intermediate2-Yes" name="intermediate2" value="yes" checked>
                                                        <label for="yes" style="font-weight: 500;">Yes</label>
                                                      </div>
                                                      <div>
                                                        <input type="radio" id="intermediate2-No" name="intermediate2" value="no">
                                                        <label for="no" style="font-weight: 500;">No</label>
                                                      </div>
                                                    </div>
                                                  </div>
