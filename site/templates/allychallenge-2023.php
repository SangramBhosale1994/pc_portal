...
header("X-Frame-Options: ALLOW-FROM https://allychallengelms.thepridecircle.com");
header("X-XSS-Protection: 0");
// header("Content-Security-Policy: frame-ancestors https://allychallengelms.thepridecircle.com");
// Content-Security-Policy: frame-ancestors 'self' https://www.maindomain.com;


header("Content-Security-Policy: frame-ancestors 'self' https://allychallengelms.thepridecircle.com");
...
<head>
	...
	<style>
		...
		iframe[src="https://allychallengelms.thepridecircle.com/"] {
			height: 700px;
		}
...
<body>
	...
	<?php if ($page->register_title != "") { ?>
		<div class="[ pt-4 ][ container ]">
			<div id="play-here">
				<div class="[ pb-2 ][ text-center  ]">
					...
					?>
						<h2 class="title_font black_text"><span class="badge title_break_style black_text"><?= $page->register_title ?></span></h2>
					<?php
					}
					?>
				</div>
		...
		<iframe src="https://allychallengelms.thepridecircle.com/?ref=<?=$ref?>" width="100%" height="600" sandbox="allow-same-origin allow-scripts allow-forms allow-popups allow-popups-to-escape-sandbox"></iframe>
	...
	<?php if ($page->leaderboard_title != "") { ?>
		<div class="[ pt-5 ][ container ]">
			...
			<iframe src="https://allychallengelms.thepridecircle.com/public-leaderboard" width="100%" height="600"></iframe>
		</div>
	<?php } ?>
