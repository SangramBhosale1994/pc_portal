...
<body id="page-top">
   ...
   <!--             </a>-->
		...
		<div id="content-wrapper" class="d-flex flex-column content_dashboard" style="">
            ...
            <img src="<?=$rootpath;?>images/seller_banner_web.jpeg" class="[ img-fluid ]( mobile-hide )" alt="Pride Circle Banner Image">
             <img src="<?=$rootpath;?>images/rainbow_bazaar_universe_mobile_banner_4401x729.jpg" class="[ img-fluid ]( mobile-show )" alt="Pride Circle Banner Image">
            </div>
				<!-- Topbar -->
