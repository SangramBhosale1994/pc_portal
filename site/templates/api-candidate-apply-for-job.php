...
//echo wire("session")->oauth_gmail;
		$user_page = Wire("pages")->get("name=candidates")->child("oauth_gmail=".wire("session")->oauth_gmail);
		...
		// 	return;
		// }
		$job_page = Wire("pages")->get("name=jobs")->child("job_code=".$job_code_to_add);
		 $about_job="true";
