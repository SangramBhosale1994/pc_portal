...
?>
				...
				<div class="container-fluid">
					...
					<div class="card shadow mb-4">
						...
						<div class="[ card-header ][ py-3 ][ d-flex flex-row justify-content-between ]">
							...
							<button id="create_new_modal_trigger_button" class="[ btn btn-primary ]( selected-action-button )" type="button" ><i class="[ mr-2 ][ fas fa-sync-alt ]"></i> Refresh</button>
                           ...
                           <div class="tab-content" id="pills-tabContent">
										...
										<table id="skills_dataTable" class="[ table table-bordered hover ]" width="100%" cellspacing="0">
											<thead>
												<tr>
													...
													<th>Candidates</th>
													<th>Synonyms</th>
													<th style="width: 102px!important;">Edit</th>
												</tr>
											</thead>
												<tbody>
													<?php
													$skill=json_decode($page->old_skills_matrix);
													...
													?>
														<tr>
															<!-- <td><input id="" class="" type="checkbox"/></td> -->
															<td><?=$key;?></td>
															<td><?=$value->number_of_candidates;?></td>
															<td><?=implode(", ",$value->synonyms);?></td>
															<td><button id="" class="[ btn btn-primary ]( profile_edit_button )" type="button" data-toggle="modal" data-target="#edit_skill_modal"><i class="[ mr-2 ][ fas fa-user-edit ]"></i>Edit skill</button></td>
														</tr>
												<?php } ?>
													</tbody>
											...
											<thead>
												<tr>
													...
													<tbody>
														<?php
														// $syno=implode(" ",$value);
														$soft_skill=json_decode($page->soft_skills_matrix);
														$counter=0;
														...
														?>
															<tr>
																...
																<td><?=$value->number_of_candidates;?></td>
																<td><?=implode(", ",$value->synonyms);?></td>
																<td><button id="<?=$counter?>_edit_button" class="[ btn btn-primary ]( profile_edit_button )" type="button"><i class="[ mr-2 ][ fas fa-user-edit ]"></i>Edit skill</button></td>
															</tr>
													<?php } ?>
													</tbody>
										</table>
                                ...
                                <div class="tab-pane fade" id="pills-technical-skills" role="tabpanel" aria-labelledby="pills-contact-tab">
									<div id="table_container" class="table-responsive">
										...
										<table id="technical_skills_dataTable" class="[ table table-bordered hover ]" width="100%" cellspacing="0">
											...
											<tbody>
												<?php
												$technical_skills=json_decode($page->technical_skills_matrix);
                                ...
                                <div class="tab-pane fade" id="pills-non-technical-skills" role="tabpanel" aria-labelledby="pills-contact-tab">
									<div id="table_container" class="table-responsive">
											...
											<tbody>
												<?php
												$non_technical_skills=json_decode($page->non_technical_skills_matrix);
												foreach ($non_technical_skills as $key => $value) {
													// echo "<tr>";
													// echo "<td>" . $key . "</td>\n<td>" . $value . "</td>";
													// echo "</tr>";
													//$synon=implode($value);
	...
	<div id="edit_skill_modal" class="[ modal fade ]" tabindex="-1" role="dialog" aria-labelledby="edit_profile_modal" aria-hidden="true">
		<div class="[ modal-dialog modal-lg ]" role="document">
			<div class="[ modal-content ]">
				<div class="[ modal-header ]">
