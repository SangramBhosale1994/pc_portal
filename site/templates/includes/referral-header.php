...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion " id="accordionSidebar">
			...
			<a class="sidebar-brand d-flex align-items-center justify-content-center" >
				...
				<div class="sidebar-brand-text mx-3 sidebar_to_text" style="color:white;"><b><?=$session->name."</b><br>".$session->email."</b><br>"?></span></div>
   ...
   <!--                 </ul>-->
			...
			<!-- Nav Item - Dashboard -->
			 <li class="nav-item">
				<a class="nav-link" href="<?=$config->urls->httpRoot?>universe/referral-dashboard">
    ...
    <!--            </div>-->
    <!--        </li>-->
			<?php if($session->user_type == "company_referrer"){
			?>
			<!--<li class="nav-item active">-->
   ...
   <!--             </a>-->
		...
		<div id="content-wrapper" class="d-flex flex-column content_dashboard" style="">
            ...
            <img src="<?=$pages->get("name=referrer-header")->banner_image->httpUrl?>" class="[ img-fluid ]( mobile-hide )" alt="Pride Circle Banner Image">
             <img src="<?=$pages->get("name=referrer-header")->Banner_image_mobile->httpUrl?>" class="[ img-fluid ]( mobile-show )" alt="Pride Circle Banner Image">
            </div>
				<!-- Topbar -->
