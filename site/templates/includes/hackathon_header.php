...
<head>
    ...
    <meta property="og:image" content='<?=$pages->get('name=hackathon-header')->general_image->httpUrl;?>'>
    <meta property="og:description" content="<?=$pages->get('name=hackathon-header')->og_description?>">
    <meta property="og:url" content="<?= $page->httpUrl ?>">
    <meta property="og:type" content="article" />

    <meta name="twitter:title" content='<?=$page->title;?>'>
    <meta name="twitter:description" content="<?=$pages->get('name=hackathon-header')->og_description?>">
    <meta name="twitter:image" content='<?=$pages->get('name=hackathon-header')->general_image->httpUrl;?>'>
...
?>
	<nav id="navbar" class="[ hide-header-mobile-view navbar fixed-top navbar-expand-lg navbar-light bg-white ]">
		<a  href="<?=$pages->get("name=hackathon-header")->header_logo1->description;?>"><img id="navbar-md-logo" class="[  header_logo_one ][ d-none d-md-inline-block ]" src="<?=$pages->get("name=hackathon-header")->header_logo1->httpUrl;?>" style="width:50px; height:auto"  alt=""></a>

		<div class="[ container ]">
		    <div class="navbar_container">
		        <a  class=" [ navbar-brand mobile_1st_logo ][ d-sm-inline-block d-md-none ]" href="<?=$pages->get("name=hackathon-header")->header_logo1->description;?>" >
    				<img class="navbar_img" src="<?=$pages->get("name=hackathon-header")->header_logo1->httpUrl;?>" style="width:50px; height:auto"  alt="">		
    			</a>
    			<?php
    			  if($pages->get("name=hackathon-header")->header_logo2!=""){
    			?>
    			<a target="_blank" class=" [ navbar-brand mobile_2nd_logo ][ d-sm-inline-block d-md-none ]" href="<?=$pages->get("name=hackathon-header")->header_logo2->description?>">
    				<img class="navbar_img" src="<?=$pages->get("name=hackathon-header")->header_logo2->httpUrl;?>" style="width:69px; height:auto"  alt="">	
    			</a>
          		<?php
    			  }
    			?>
			...
			<div class="[ collapse navbar-collapse ]" id="navbarNav">
				<ul class="[ w-100 ][ d-flex align-items-center justify-content-md-around flex-sm-row justify-content-sm-center ][ navbar-nav ]">
				    <?php
				        foreach($pages->get("name=hackathon-header")->header_menus as $header_menus){
		...
		<?php
			if($pages->get("name=hackathon-header")->header_logo2!=""){
		?>
		<a target="_blank" href="<?=$pages->get("name=hackathon-header")->header_logo2->description;?>"> <img id="navbar-md-logo" class="[  header_logo_two ][ d-none d-md-inline-block ]" src="<?=$pages->get("name=hackathon-header")->header_logo2->httpUrl;?>" style="width:69px; height:auto"  alt=""></a>
		<?php
			}
		?>
	</nav>
				...
				<div class="container">
				    <div class="d-flex justify-content-between img-responsive">
				        <div  style=" margin-right: 0;" >
				           <a href="<?=$pages->get("name=hackathon-header")->header_logo1->description;?>"  class="standard-logo img-responsive"  >
						   		<img style="height: 80px; width: auto; padding: 5px" src="<?=$pages->get("name=hackathon-header")->header_logo1->httpUrl;?>" alt="Pride Circle Logo"/>
				           </a> 
				        </div>
				        <div>
				           ...
				           <nav class="primary-menu" style="height: 80px; ">
    							<ul class="menu-container" style="justify-content: center; margin-right: 0px;">
    								...
    								<?php
    									...
    									foreach($pages->get("name=hackathon-header")->header_menus as $header_menu){
				        ...
				        <div id="logo-right" class="header-logo" style=" margin-right: 0;" >
				           <a href="<?=$pages->get("name=hackathon-header")->header_logo2->description;?>" target="_blank" class="standard-logo img-responsive" >
						   	<img  style="height: 80px; width: auto; padding: 5px" src="<?=$pages->get("name=hackathon-header")->header_logo2->httpUrl;?>" alt="Pride Circle Logo"/>
				           </a>
			...
			<div id="header-wrap">
				<div class="container">
					<div class="header-row">
						...
						============================================= -->
						<div id="logo">
							<a href="<?=$pages->get("name=hackathon-header")->header_logo1->description;?>" class="standard-logo" data-dark-logo="<?=$page->child("name=hackathon-header")->header_logo1->httpUrl;?>"><img src="<?=$pages->get("name=hackathon-header")->header_logo1->httpUrl;?>" alt=""></a>
							<a href="<?=$pages->get("name=hackathon-header")->header_logo1->description;?>" class="retina-logo" data-dark-logo="<?=$page->child("name=hackathon-header")->header_logo1->httpUrl;?>"><img src="<?=$pages->get("name=hackathon-header")->header_logo1->httpUrl;?>" alt=""></a>
						</div><!-- #logo end -->

						<div class="header-misc">
							<a target="_blank" href="<?=$pages->get("name=hackathon-header")->header_logo2->description;?>" class="standard-logo" data-dark-logo="<?=$page->child("name=hackathon-header")->header_logo2->httpUrl;?>"><img style="height: 60px;margin-top:0.4rem;margin-bottom: 0.4rem;" src="<?=$pages->get("name=hackathon-header")->header_logo2->httpUrl;?>" alt=""></a>
						</div>
