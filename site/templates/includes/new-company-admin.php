	...
	<div id="wrapper">
		...
		<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
			...
			<a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
				...
				<div class="sidebar-brand-text mx-3">RISE 2021</div>
			...
			<!--</li>-->
			<li class="nav-item active">
				<a class="nav-link" href="<?=$config->urls->httpRoot ?>resume/pc-admin/company-data/">
						...
						<div class="topbar-divider d-none d-sm-block"></div>
                            <?php 
                                if($session->user_type == 'company_admin'){
                                    ...
                                    $company_user_type = "Company Sub-user";
                                }
                            ?>
						<!-- Nav Item - User Information -->
						<li class="nav-item dropdown no-arrow">
							<a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
							    <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?=$session->name."<br>".$session->company_name?></span>
					...
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							...
							<div class="modal-footer">
								...
								<a class="btn btn-primary" href="<?=$urls->httpRoot?>universal-logout">Logout</a>
							</div>
						</div>
					</div>
				</div>
