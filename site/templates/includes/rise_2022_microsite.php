...
?>
				...
				<?php 
					...
					<div class=" col-lg-6 col-md-6 mb-3">
					    <div class="story-box-info p-3" style="border: 1px solid #000033;border-radius: 0.25rem;">
							<h3 class="title_new center" style="margin: 7px;"><?=$cards_section->bank_name;?></h3>
								<div class="story-box-content">
									<div style="color:#003;" class="cards-text"><?=$cards_section->text_description;?></div>
				...
				<?php 
					...
					<div class=" col-lg-12 col-md-12 mb-3">
					    <div class="story-box-info p-3" style="border: 1px solid #000033;border-radius: 0.25rem;">
							<h3 class="title_new center" style="margin: 7px;"><?=$cards_section->bank_name;?></h3>
								<div class="story-box-content">
									<div style="color:#003; height:auto !important" class="cards-text"><?=$cards_section->text_description;?></div>
			
									<!-- <a class="flex-spacing right-margin-header"  href="<?=$cards_section->heading3;?>"><button class="btn-outline-primary-new font-weight-light button ml-0 button-rounded"><?=$cards_section->heading2;?></button></a> -->
									<div class="">
										<h4 style="" class="mt-2 center text-white"><?=$cards_section->heading2;?></h4>
					...
					<div class="container clearfix mb-6">
						<div class="bs-example">
							...
							<?php 
								...
								?>
								<li class="nav-item">
								<a class="nav-link active show" id="pills-home-tab" data-toggle="pill" href="#schedule1" role="tab" aria-controls="pills-home" aria-selected="true"><?=$jobfair_agenda->title;?></a>
								</li>
								<?php
								}
								?>
								...
								?>
								<li class="nav-item">
								<a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#schedule2" role="tab" aria-controls="pills-profile" aria-selected="false"><?=$conference_agenda->title;?></a>
								</li>
								<?php
								}
								?>
											...
											<div class="row agenda_section " style="margin-right: 0px !important; margin-left: 0px !important; ">
												<div class="col-md-12 grid-margin-md stretch-card d-flex_" style="">
													<div class="cardnew active">
														<div class="card-title center font-weight-normal  letter note mb-0" style="align-items: center;margin-top: 1.5rem;color:#000033;"><?=$jobfair_agenda->text_description;?></div>	  
													</div>
												</div>  				   
											</div>
										</div> 
									...
									<div class="content-wrap" style="padding: 0px 0 !important;">
										<div class="containernew container clearfix">
											<div class="row agenda_section " style="margin-right: 0px !important; margin-left: 0px !important; ">
												<div class="col-md-12 grid-margin-md stretch-card d-flex_" style="">
													<div class="cardnew active">
														<div class="card-title center font-weight-normal  letter note mb-0" style="align-items: center;margin-top: 1.5rem;color:#000033;"><?=$conference_agenda->text_description;?></div>								   
				...
				<div id="section-multipage" class="page-section center bg-transparent mb-0 clearfix">
					<div class="px-5 container-fluid" style="max-width: 1600px">
						<div class="title_new heading-block center border-bottom-0 mb-0">
                            <h3 class="mb-4 mt-6"><?=$pages->get("name=rise2022-speakers")->covid_19_title;?></h3>
                        </div>
						...
						<div id="intro-multipages-container" class="row col-mb-50 mb-3 justify-content-center">
						    <?php 
                            foreach($speakers_type->children("limit=5") as $speakers_detials)
                            {
                            ?>
			...
			<!-- <section id="content m///t-1" style="" > -->
			    <div class="content-wrap" style="margin-bottom: -2rem !important;" >
				<div id="event-passes"></div>
					<div class="text-center title-center title-border topmargin-sm" style="margin-bottom: 5rem; background-color:#fbdd0d; height: 4rem;padding-top: 0.9rem;">
						<h3 class="title_new" style="color:#000033;"><?=$page->heading8;?></h3>
					</div>
				</div>
					...
					<?php 
						...
						<div class=" col-lg-6 col-md-6 mb-3">
							<div class="story-box-info p-3" style="border: 1px solid rgba(0, 0, 0, 0.125);border-radius: 0.25rem;background-color:rgb(32, 68, 150);">
								<h3 class="title_new center text-white" style="margin: 7px;"><?=$event_passes_repeater->title;?></h3>
								<div class="mt-3 event-passes-text-color event-passes-height center  event_passes_text">
									<?=$event_passes_repeater->text_description;?>
								</div>	
									<div class="story-box-content1">
										<div style="" class="center text-white"><?=$event_passes_repeater->heading2;?></div>
										<div class="row justify-content-center  mb-3 mt-3" style="max-width: 640px;">
											<a class="flex-spacing"  href="<?=$event_passes_repeater->heading4;?>"><button style="font-weight: 550 !important;" class="button-grey btn-outline-event-passes font-weight-light button ml-0 button-rounded"><?=$event_passes_repeater->heading3;?></button></a>
										</div>
									</div>
							</div>
						</div>
						...
						<?php 
						foreach($page->event_passes_repeater1 as $event_passes_repeater1)
						{
						?>
						<div class=" col-lg-6 col-md-6 mb-3">
							<div class="story-box-info p-3" style="border: 1px solid rgba(0, 0, 0, 0.125);border-radius: 0.25rem;background:#8A2527;">
								...
								<div class="mt-3 event-passes-height center text-white event_passes_text">
									<?=$event_passes_repeater1->text_description;?>
								</div>
									<div class="story-box-content1">
										<div style="color:#8A2527;" class="center"><?=$event_passes_repeater1->heading2;?></div>
										<div class="row justify-content-center  mb-3 mt-3" style="max-width: 640px;">
											<a class="flex-spacing"  href="<?=$event_passes_repeater1->heading4;?>"><button style="font-weight: 550 !important;" class="button-grey btn-outline-event-passes font-weight-light button ml-0 button-rounded"><?=$event_passes_repeater1->heading3;?></button></a>
										</div>
									</div>
							</div>
						</div>
			...
			<div class="container mt-2 mb-6">
				...
				<?php 
                    ...
                    ?>
					<div class=" col-lg-12 col-md-12 mb-3">
					    <div class="story-box-info p-3" style="border: 10px solid #000033;border-radius: 0.25rem;">
			...
			<div class="container-fluid title-center title-border mt-6 text-center" style="margin-bottom: 3rem; background-color:#ea2127;height: 4rem;padding-top: 0.9rem;">
