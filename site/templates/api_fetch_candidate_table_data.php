...
// 			$company_data->registration_time=date('d/m/Y h:i A', $company_data->registration_time);
				  ...
				  break;
					...
					case "how_did_you_know_about_workshop":
						...
						if($event_code!=""){
							$event_page_for_applicant = Wire("pages")->get("name=workshops")->child("event_code=".$event_code);
					...
					case "how_did_you_know_about_job":
						...
						if($job_code!=""){
							$job_page_for_applicant = Wire("pages")->get("name=jobs")->child("job_code=".$job_code);
