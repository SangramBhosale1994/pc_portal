...
<?php
    ...
    function read_resume(){
      ...
      include_once wire('config')->paths->templates.'pdfparser-master/vendor/autoload.php';
      ...
      foreach(wire('pages')->get("name=candidates")->children("created|modified>".$current_timestamp) as $candidate_page){
