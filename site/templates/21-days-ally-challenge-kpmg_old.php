...
<head>
	...
	<!--<title>KPMG #21DaysAllyChallenge | Pride Circle</title>-->
	...
	<!--<meta property="og:title" content="KPMG 21 Days Ally Challenge | Pride Circle">-->
	<meta property="og:title" content="#Ally Challenge | Pride Circle">
	<meta property="og:image" content="<?= $rootpath;?>images/slide-7.jpg">
	<!--<meta property="og:description" content="KPMG #21DaysAllyChallenge">-->
	...
	<!--<meta name="twitter:title" content="KPMG 21 Days Ally Challenge | Pride Circle">-->
	...
	<!--<meta name="twitter:card" content="KPMG 21DaysAllyChallenge">-->
		<meta name="twitter:card" content="#AllyChallenge">

	<meta property="og:site_name" content="Pride Circle">
	<!--<meta name="twitter:image:alt" content="KPMG 21DaysAllyChallenge">-->
...
.challenge-comin-soon-container{
	width: 540px;
}
...
<body>
	<nav id="navbar" class="[ navbar fixed-top navbar-expand-lg navbar-light bg-white ]">
		<img id="navbar-md-logo" class="[ ml-5 ][ d-none d-md-inline-block ]" src="<?=$rootpath?>images/pride_circle_logo_square.jpg" style="width:58px; height:auto"  alt="">

		<div class="[ container ]">
			<a class=" [ navbar-brand ][ d-sm-inline-block d-md-none ]" href="#">
				<img src="<?=$rootpath?>images/pride_circle_logo_square.jpg" style="width:40px; height:auto"  alt="">
				

				<!--<strong style="font-size: 1rem; margin-right: 5px; margin-left:5px" class="">-->
				...
				<!--</strong>-->
				<strong style="font-size: 1rem; margin-right: 5px; margin-left:5px" class="">
					<span style="color:#FF6666"> #</span><span style="color:#66CCFF" font-weight: 600;>Ally</span><span style="color:#BFA6D0">Challenge </span>
				</strong>

				<img src="<?=$rootpath?>images/KPMG_logo.png" style="width:78px; height:auto"  alt="">
			</a>
			...
			<div class="[ collapse navbar-collapse ]" id="navbarNav">
				<ul class="[ w-100 ][ d-flex align-items-center justify-content-md-around flex-sm-row justify-content-sm-center ][ navbar-nav ]">
					...
					<a target="_blank" class="nav-link ( underline-button )" style="font-weight: 600;" href="https://www.thepridecircle.com/">About Us</a>
					</li>
					<!-- <li class="nav-item">
		...
		<img class="[ mr-5 ][ d-none d-md-inline-block ]" src="<?=$rootpath?>images/KPMG_logo.png" style="width:110px; height:auto"  alt="">
	</nav>
	...
	<div class="[ d-none d-md-block ]( icon-bar )">
		...
		<!--<a target="_blank" href="mailto:contact@thepridecircle.com?subject=21DaysAllyChallenge" class="about_us_social_link" title="contact@thepridecircle.com"><i class="fa fa-envelope"></i></a>-->
			...
			<a target="_blank" href="mailto:contact@thepridecircle.com?subject=AllyChallenge" class="about_us_social_link" title="contact@thepridecircle.com"><i class="fa fa-envelope"></i></a>
	</div>

	<div id="slider_container" class="[ px-md-5 pb-5 ][ container ]">
		<div id="carouselExampleIndicators" class="[mx-md-5][ carousel slide ]" data-ride="carousel">
			<div class="carousel-inner">
				<div class="carousel-item active">
					<img class="d-block w-100" src="<?= $rootpath;?>images/600x480.png" alt="First slide">
				</div>
				...
				<!-- <div class="carousel-item">
					<img class="d-block w-100" src="<?= $rootpath;?>images/msr-slide-2.PNG" alt="First slide">
				</div>

				<div class="carousel-item">
					<img class="d-block w-100" src="<?= $rootpath;?>images/msr-slide-3.PNG" alt="First slide">
				</div>

				<div class="carousel-item">
					<img class="d-block w-100" src="<?= $rootpath;?>images/msr-slide-4.PNG" alt="First slide">
				</div>

				<div class="carousel-item">
					<img class="d-block w-100" src="<?= $rootpath;?>images/msr-slide-5.jpg" alt="First slide">
				</div>

				<div class="carousel-item">
					<img class="d-block w-100" src="<?= $rootpath;?>images/msr-slide-6.PNG" alt="First slide">
				</div>

				<div class="carousel-item">
					<img class="d-block w-100" src="<?= $rootpath;?>images/msr-slide-7.PNG" alt="Second slide">
				</div>

				<div class="carousel-item">
					<img class="d-block w-100" src="<?= $rootpath;?>images/msr-slide-8.PNG" alt="Third slide">
				</div>

				<div class="carousel-item">
					<img class="d-block w-100" src="<?= $rootpath;?>images/msr-slide-9.PNG" alt="Third slide">
				</div>

				<div class="carousel-item">
					<img class="d-block w-100" src="<?= $rootpath;?>images/msr-slide-10.PNG" alt="Third slide">
				</div>

				<div class="carousel-item">
					<img class="d-block w-100" src="<?= $rootpath;?>images/msr-slide-11.PNG" alt="Third slide">
				</div> -->
			</div>
	...
	<div id="play-here" class="[ pt-5 pb-2 ][ container ]">
		...
		<div class="[ mx-md-5 px-md-5 mt-3 ][ row ]">
			...
			<div class="[ col-md-4 ][ text-center ]">
				<a class="[ pb-2 ]( underline-button )" href="#">Get Started</a>
			</div>

			<div class="[ col-md-4 ][ text-center ]">
				<a class="[ px-4 pb-2 ]( underline-button )" href="#">FAQ</a>
			</div>

			<div class="[ col-md-4 ][ text-center ]">
				<a class="[ pb-2 ]( underline-button )" href="#">Terms & Conditions</a>
			</div>
		</div>
	...
	<div class="[ container ]">
		<div class="[ row ]">
			<div class="[ offset-md-2 col-md-8 ][ pt-3 pb-3 ]">
				...
				<div style="margin:auto; height:18rem; border:2px solid rgb(66,139,202); overflow-y: auto; padding-top:0px !important;" class="( challenge-comin-soon-container )[ p-md-2 pt-md-none ][ text-center ]">
					<h3 class="[ pt-5 mt-5 text-muted ]">The challenges will be live soon!</h3>
				</div>
	...
	<div id="leaderboard" class="[ pt-5 pb-2 ][ container ]">
		<div class="[ pt-4 pb-2 ][ text-center ]">
			<h1 style="font-weight: 600;">LEADERBOARD</h1>
		</div>
		...
		<div>
			...
			<div style="margin:auto; width:100%; height:18rem; border:2px solid rgb(66,139,202); overflow-y: scroll; padding-top:0px !important;" class="[ p-md-2 pt-md-none ]">
				<div class="[ text-center ]">
					<!-- <table class="table">
						<thead>
						...
						<tbody>
							<?php
								$individual_leaderboard_array = $page->child("name=msr-ally-challenge-leaderboard-update")->ally_challenge_leaderboard_individual;
					...
					<!-- <h3 class="[ pt-5 mt-5 text-muted ]">The LeaderBoard will be updated everyday at 12 PM CEST.<br>Participants can keep track of their score here.</h3> -->
					<h3 class="[ pt-5 mt-5 text-muted ]">The LeaderBoard will be live soon!</h3>
				</div>
	...
	<!-- <div id="winners" class="[ pt-5 px-md-5 pb-5 ][ container text-center ]">
		<div class="[ pt-4 pb-4 ]">
			<h1>WINNERS</h1>
		</div>
...
<div id="resources" class="[ py-5 container ]">
	<div class="[ pt-4 pb-2 ][ text-center ]">
		<h1 style="font-weight: 600;">RESOURCES</h1>
	</div>
	...
	<div class="[ py-5 px-5 ][ container ][ d-block d-md-none ]">
		...
		<div class="[  d-flex justify-content-around ]( mobile-icon-bar )">
			...
			<a target="_blank" href="mailto:contact@thepridecircle.com?subject=AllyChallenge" class="about_us_social_link"><i class="fa fa-fw fa-envelope"></i></a>
		</div>
	</div>
...
//print_r($participating_companies_array);
	...
	<!-- <div class="[ mt-3 py-5 ][ container ]">
		...
		<div class="[ mx-md-5 px-md-5 ][ d-md-flex justify-content-md-around ]">
			<div class="[ p-5 ][ align-self-center ][ text-center ]">
				<img class="[ img-fluid ]" style="max-width:220px; height:auto" src="<?= $rootpath;?>images/200x200.png" alt="">
			</div>
