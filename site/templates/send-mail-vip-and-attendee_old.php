...
include 'includes/send_mail_ticketing.php';
    ...
    // 		echo "************************";
    // 		echo $vip_attendee_page->title;
    // 		echo "************************";
    // 		echo $vip_attendee_page->serial_id;
    // 		echo "\n";
    		
    		$event_name = "RISE 2021";
    		$pass_number=$vip_attendee_page->serial_id;
    		$applicants_name=$vip_attendee_page->title;
    		$applicants_email=$vip_attendee_page->email;
    		$applicants_contact=$vip_attendee_page->phone_country_code."".$vip_attendee_page->phone_number;
    		
    		$event_link="https://rise2021.vtour.tech/";
    		$visit_link="https://www.thepridecircle.com/rise2021/";
    		$video_guide="https://youtu.be/Qf-w-YuNl9k";
    		
    		$applicants_subject="RISE 2021 | Conference Pass and Details";
    
    		$applicants_message ="Hello {$applicants_name},";
    		
    		$applicants_message .="<br><br>";
    		$applicants_message .="Welcome to RISE Conference 2021, May 4th & 5th.";
    		$applicants_message .="<br><br>";
    		...
    		$applicants_message .="            <b>Date</b>: May 4th & 5th</b>";
    		$applicants_message .="            <br>";
    		$applicants_message .="            <b>Time</b>: 1.00pm to 5.30pm IST and 8.00pm to 10pm IST</b>";
    		$applicants_message .="            <br>";
    		$applicants_message .="            <b>Join the Event</b>: {$event_link}";
    		$applicants_message .="            <p style='margin-top:0px; margin-bottom:0px;'>[Link will be LIVE only from 4th May 10:00 am IST] </p>\n";  
    // 		$applicants_message .="            <br>";
    		$applicants_message .="            <b>Name</b>: {$applicants_name}";
    		$applicants_message .="            <br>";
    		$applicants_message .="            <b>Contact Number</b>: {$applicants_contact}";
    		$applicants_message .="            <br>";
    		$applicants_message .="            <b>Conference Agenda</b>:  <a href='https://www.thepridecircle.com/site/assets/files/8536/rise_2021_-_agenda_30-04.pdf'>Download</a> ";
    		$applicants_message .="            <br>";
    		$applicants_message .="            <b>Learn more</b>: <a href='{$visit_link}'>Visit</a>";
    		$applicants_message .="            <br>";
    		$applicants_message .="            <b>Platform opens at</b>: 4th May, 10:00am (IST)";
    		$applicants_message .="        </td>";
    		$applicants_message .="    </tr>";
    		$applicants_message .="</table>";
    		...
    		$applicants_message .="</ul>";
    // 		$applicants_message .="<br>";
    		$applicants_message .="<p style='font-weight: 400;'>Here is a video guide to help you navigate the platform:&nbsp;<a href='{$video_guide}'>https://youtu.be/Qf-w-YuNl9k</a></p>";
    		$applicants_message .="<br>";
    		$applicants_message .="<hr>";
    		$applicants_message .="<br>";
    		...
    		//$email="namrata@thepridecircle.com";
