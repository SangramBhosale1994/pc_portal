...
// 		}
		...
		elseif(!$data_to_return->profile_to_edit){
			if($np->identify_as =="Male" || $np->identify_as =="Female" || $np->identify_as =="Straight" || $np->identify_as =="Men" || $np->identify_as =="Man" || $np->identify_as =="Women" || $np->identify_as =="male" || $np->identify_as =="female" || $np->identify_as =="straight" || $np->identify_as =="men" || $np->identify_as =="man" || $np->identify_as =="women"){
...
if(($np->lgbtq_verification=="Unchecked" || $np->lgbtq_verification=="" ) && $input->post->lgbtq_verification=="Confirmed"){
						...
						/* pass applicants save pass verification verified and send mail*/
							...
							$job_fair_page = wire("pages")->get("name=pass-applicants")->child("candidate_profile_id=".$np->id);
							...
							//echo"5";
									...
									$applicants_subject="RISE JOB FAIR 2021 | EVENT PASSES";
							
									$applicants_message ="Dear {$applicants_name},";
									
									$applicants_message .="<br><br>";
									$applicants_message .="You have successfully registered for ASIA'S BIGGEST LGBT+ JOB FAIR - RISE 2021 !";
									$applicants_message .="<br><br>";
									$applicants_message .="Explore our all new virtual platform on 8th May and meet some of the top inclusive organisations from across the country.";
									...
									$applicants_message .="<br><br>";
									$applicants_message .="In case of any questions or entry correction requests, please drop us a mail before 20th April 2021, explaining the query along with your details
							and ticket ID on contact@thepridecircle.com</b>";
									$applicants_message .="<br>";
