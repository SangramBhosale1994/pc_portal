...
// 	}
	...
	$user_data_set['qualification'] = $user_page->qualification;
...
<body>
	...
	<form id="main-container" class="[ my-5 px-sm-5 ][ container rounded tab-content ][ needs-validation ]" action="<?=$config->urls->httpRoot?>resume/thank-you/?edit_application=<?=$user_page->id?>&page_id=<?=$user_page->id?>" method="POST" enctype="multipart/form-data" novalidate>
		...
		<div id="personal-tab" class="[ tab-pane fade show active ]" role="tabpanel" aria-labelledby="personal-tab">
			...
			?>
			<!--<div id="referrer_code_container" class="[ my-5 <?php 
			...
			<!--	<input id="referrer_code" class="form-control" type="text" value="<?php 
			...
			<div class="[ my-5 ][ form-group ]">
				...
				<div class="[ custom-control custom-radio ]">
					<input type="radio" id="lgbtq_verification_confirmed" value="Confirmed" name="lgbtq_verification" class="custom-control-input" required>
					<label class="custom-control-label" for="lgbtq_verification_confirmed">Confirmed</label>
				</div>

				<div class="[ custom-control custom-radio ]">
					<input type="radio" id="lgbtq_verification_rejected" value="Rejected" name="lgbtq_verification" class="custom-control-input" required>
			...
			<div class="[ my-5 ][ form-group ]">
				...
				<div class="custom-file">
					<!--<input  id="redacted_resume" name="redacted_resume" class="custom-file-input" type="file" accept=".pdf, .docx, .doc">-->
					<input  id="redacted_resume" name="redacted_resume" class="custom-file-input" type="file" >
					<label id="redacted_resume_label" class="custom-file-label" for="resume">PDF or MS Word files only</label>
