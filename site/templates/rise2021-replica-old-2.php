...
<head>
    ...
    <meta property="og:image" content='<?=$urls->httpTemplates?>Copy of banner-mobile.jpg'>
    ...
    <meta name="twitter:image" content='<?=$urls->httpTemplates?>Copy of banner-mobile.jpg'>
				        ...
				        <div>
				           ...
				           <nav class="primary-menu d-md-none">
    							<ul class="menu-container">
    								...
    								<li class="menu-item mega-menu"><a class="menu-link" href="<?=$page->httpUrl;?>#footer"><div>CONTACT US</div></a></li>
    								<li class="menu-item mega-menu"><a class="menu-link" href="<?=$page->httpUrl;?>#FAQs"><div>FAQS</div></a></li>
    							</ul>
						    </nav>
                              ...
                              <div class="col-md-4 tickets_column">
                                <div class="card" style="">
                                  <div class="card-body">
                                   ...
                                   <div  class="card-height center" style="color:#333">End poverty in all its forms everywhere</div>
                                  </div>
                                </div>
                              </div>
                              <div class="col-md-4 tickets_column">
                                <div class="card tickets_column " style="">
                                  <div class="card-body">
                                   ...
                                   <div class="card-height center" style="color:#333">Ensure inclusive and equitable quality education and promote  lifelong learning opportunities for all</div>    
                                  </div>
                                </div>
                              </div>
                               <div class="col-md-4 tickets_column">
                                <div class="card " style="">
                                  <div class="card-body">
                                   ...
                                   <div class="card-height center" style="color:#333">Promote peaceful and inclusive societies for sustainable development, provide access to justice for all and  build effective, accountable and inclusive  institutions at all levels</div>   
                                  </div>
                                </div>
                              </div>
                        </div>
            ...
            <div class="container">
               ...
               <div id="oc-testi" class="owl-carousel testimonials-carousel carousel-widget" data-margin="20" data-items-sm="1" data-items-md="2" data-items-xl="3">
						...
						<div class="oc-item">
							<div class="">
								<div class="">
									<a href="#"><img style="width:180px;height:180px;object-fit:contain;margin-right:2px;" src="<?=$repeater->ally_banner_image->httpUrl;?>" alt="Customer Testimonails"></a>
								</div>
                ...
                <div class="container">
                    <div class="row justify-content-center" style="border: 3px solid #502a75;border-radius: 10px;padding:35px;">
                        <div class="heading-block center border-bottom-0 mb-0">
                            <div class="nott">Want to extend support to our vision?</div>
                            <div>For all sponsorship enquiries, please reach out to</div>
                            <div><a href="mailto:contact@thepridecircle.com" data-scrollto="#section-testimonials" data-easing="easeInOutExpo" data-speed="1250" style="color: #502a75">contact@thepridecircle.com</a></div>
                        </div>
                    </div>
                </div>
            </div>
