...
*/
    ...
    header("Location:".$pages->get("name=job-fair")->httpUrl);
?>
        <?php 
        ...
        <a href="<?= $pages->get("name=cart")->httpUrl ?>"><button type="button" class="btn btn-primary"><i style="padding-right:1rem;" class="fa fa-shopping-cart" aria-hidden="true"></i><?$count?> Tickets 
...
<section>
    <div class="container" style="text-align:center">
        <!--<h5 style="color:red;"><i>All passes have been sold out.</i></h5>-->
        <?= $page->Text1;?>
        <h5 style="color:red;"><i>Limited offer. Avail an additional 10% discount on Group Booking of 5 or more tickets</i></h5>
    </div>
  ...
  <div class="container" >
    ...
    padding-right: 1rem; ">
                        ...
                        <div class="col-md-10 rounded event_passes_height_one " style="border:2px solid #000033;border:2px solid #2a2a81;background-color: #2a2a81; color:#ddd;">
                                <h3 class="text-center" style="margin-top:2rem; font-family: 'Montserrat', sans-serif;"><?=$single_event_fullday->ticketing_title_toshow?></h3>
                                ...
                                <div class="text-center">
                                    <a href="<?= $page->get("name=events")->child("title=".$single_event_fullday->title)->httpUrl ?>" class="btn btn-outline-primary-new">SELECT</a>
                                </div>
                        </div>
                            <div class="col-md-1"></div>
                    </div>
    ...
    <!--full day session passes-->
     <div class="container">
        <div class="row"  >
            ...
            ?>
            <div class="col-sm-12 col-md-6 col-lg-4 card-ticket-design">
                <!--<div class="card " >-->
                <!--  <div class="card-body">-->
                <!--    <h5 class="card-title"><?=$single_event_fullday->title?></h5>-->
                <!--    <p class="card-text"> <?=$single_event_fullday->ticketing_event_description?></p>-->
                        ...
                        <div class="col-md-12 rounded event_passes_height" style="border:2px solid #2a2a81;background-color: #2a2a81; color:#ddd;">
                                ...
                                <h4 class="text-center" style="font-size: 3rem;font-family: 'Montserrat', sans-serif;">INR&nbsp;<?=$single_event_fullday->ticketing_event_price?>*</h4>
                                   <!--<h5 style="text-align:center"><del style="color:red">INR <?=$single_event_fullday->ticketing_events_original_price?></del>* <span class="badge badge-pill badge-danger">50% OFF</span></h5>-->
                                    <!--<div style="text-align:center; font-family: 'Montserrat', sans-serif;"><span><del style="color:#ddd">INR&nbsp;<?=$single_event_fullday->ticketing_events_original_price?></del>*</span><span class="badge badge-pill badge-danger">40% OFF</span></div>-->
                                <style type="text/css">
                                    #ticket_description_container ul li{
                                        line-height: 21px;
                                    }
                                </style>
                                <div id="ticket_description_container" class="event_description_height" style="margin-top: 1.5rem;" >
                                    <?=$single_event_fullday->ticketing_event_description?>
                                </div>
                                <div class="text-center">
                                    <a href="<?= $single_event_fullday->httpUrl ?>" class="btn btn-outline-primary-new">SELECT</a></a>
                                </div>
                        </div>
