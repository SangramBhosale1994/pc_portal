...
<body>
	...
	<div id="to-participate" class="[ pt-5 pb-2 ][ container ]">
		...
		<div class="[ mt-3 ][ row ]">
			...
			<!-- <div class="[ col-md-6 ]">
				<iframe style="width: 100%;height: 315px;position: relative;" src="https://www.youtube.com/embed/sEGdOS6ubaM" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
			</div> -->
		</div>
	</div>
