			...
			<div class="[ modal-content ]">
				...
				<form id="create_new_modal_form" class="[ needs-validation ]" action="" method="POST" enctype="multipart/form-data">
					<div id="edit_profile_modal_body" class="[ modal-body ]">
						...
						<div class="[ mb-3 ][ form-group ]">
							<!-- <label for="create_new_event_show_workshop_popup">Is show about workshop popup to candidate?</label><br> -->
							<div class="ml-4">
								<input class="form-check-input" type="checkbox" value="show" id="event_show_workshop_popup" name="event_show_workshop_popup">
								<label class="form-check-label" for="create_new_event_show_workshop_popup" >Show "How did you know about the event?" popup</label>
								<div class="invalid-tooltip">
			...
			<div class="[ modal-content ]">
				...
				<form id="edit_profile_modal_form" class="[ needs-validation ]" action="" method="POST" enctype="multipart/form-data">
					<div id="edit_profile_modal_body" class="[ modal-body ]">
						...
						<div class="[ mb-3 ][ form-group ]">
							<!-- <label for="edit_event_show_workshop_popup">Is show about workshop popup to candidate?</label><br> -->
							<div class="ml-4">
								<input class="form-check-input" type="checkbox" value="show" id="event_show_workshop_popup" name="edit_event_show_workshop_popup">
								<label class="form-check-label" for="edit_event_show_workshop_popup" >Show "How did you know about the event?" popup</label>
								<div class="invalid-tooltip">
									Please provide a valid answer.
								</div>
							</div>
