...
<head>
	...
	<link rel="stylesheet" href="<?=$rootpath?>styles/training.css?v=24.12" type="text/css" />
...
?>
	<nav id="navbar" class="[ hide-header-mobile-view navbar fixed-top navbar-expand-lg navbar-light bg-white ]">
		<a  href="<?=$pages->get("name=training-header")->header_logo1->description;?>"><img id="navbar-md-logo" class="[  header_logo_one ][ d-none d-md-inline-block ]" src="<?=$pages->get("name=training-header")->header_logo1->httpUrl;?>" style="width:50px; height:auto"  alt=""></a>

		<div class="[ container ]">
		    <div class="navbar_container">
		        <a  class=" [ navbar-brand mobile_1st_logo ][ d-sm-inline-block d-md-none ]" href="<?=$pages->get("name=training-header")->header_logo1->description;?>" >
    				<img class="navbar_img" src="<?=$pages->get("name=training-header")->header_logo1->httpUrl;?>" style="width:50px; height:auto"  alt="">		
    			</a>
    			<?php
    			  if($pages->get("name=training-header")->header_logo2!=""){
    			?>
    			<a target="_blank" class=" [ navbar-brand mobile_2nd_logo ][ d-sm-inline-block d-md-none ]" href="<?=$pages->get("name=training-header")->header_logo2->description?>">
    				<img class="navbar_img" src="<?=$pages->get("name=training-header")->header_logo2->httpUrl;?>" style="width:69px; height:auto"  alt="">	
    			</a>
          		<?php
    			  }
    			?>
		...
		<?php
			if($pages->get("name=training-header")->header_logo2!=""){
		?>
		<a target="_blank" href="<?=$pages->get("name=training-header")->header_logo2->description;?>"> <img id="navbar-md-logo" class="[  header_logo_two ][ d-none d-md-inline-block ]" src="<?=$pages->get("name=training-header")->header_logo2->httpUrl;?>" style="width:69px; height:auto"  alt=""></a>
		<?php
			}
		?>
	</nav>
...
?>
		<header id="header" class="hide-header-mobile-view full-header sticky-header sticky-header-shrink" data-sticky-shrink="true">
			<div id="header-wrap">
				<div class="container">
				    <div class="d-flex justify-content-between img-responsive">
				        <div id="" style=" margin-right: 0;" >
				           <a href="<?=$pages->get("name=training-header")->header_logo1->description;?>"  class="standard-logo" class="img-responsive"  data-dark-logo="<?=$page->child("name=training-header")->header_logo1->httpUrl;?>"><img  style="height: 80px; width: auto; padding: 5px" src="<?=$pages->get("name=training-header")->header_logo1->httpUrl;?>" alt="Pride Circle Logo">
				           </a>
                ...
                ?>
				        <div id="logo-right" class="header-logo" style=" margin-right: 0;" >
				           <a href="<?=$pages->get("name=training-header")->header_logo2->description;?>" target="_blank" class="standard-logo" class="img-responsive"  data-dark-logo="<?=$page->child("name=training-header")->header_logo2->httpUrl;?>"><img  style="height: 80px; width: auto; padding: 5px" src="<?=$pages->get("name=training-header")->header_logo2->httpUrl;?>" alt="Pride Circle Logo">
				           </a>
                   <!-- <a target="_blank" href="<?=$page->child("name=training-header")->header_logo2->description;?>"> <img id="navbar-md-logo" class="[  header_logo_two ][ d-none d-md-inline-block ]" src="<?=$page->child("name=training-header")->header_logo2->httpUrl;?>" style="width:69px; height:auto"  alt=""></a> -->
			...
			<div class="header-wrap-clone web_herder_wrap" style="height: 10px !important;"></div>
		</header><!-- #header end -->
			...
			<div id="header-wrap">
				<div class="container">
					<div class="header-row">
						...
						============================================= -->
						<div id="logo">
							<a href="<?=$pages->get("name=training-header")->header_logo1->description;?>" class="standard-logo" data-dark-logo="<?=$page->child("name=training-header")->header_logo1->httpUrl;?>"><img src="<?=$pages->get("name=training-header")->header_logo1->httpUrl;?>" alt=""></a>
							<a href="<?=$pages->get("name=training-header")->header_logo1->description;?>" class="retina-logo" data-dark-logo="<?=$page->child("name=training-header")->header_logo1->httpUrl;?>"><img src="<?=$pages->get("name=training-header")->header_logo1->httpUrl;?>" alt=""></a>
						</div><!-- #logo end -->
