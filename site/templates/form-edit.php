...
// echo "form-edit";
	...
	elseif($pages->get("oauth_gmail=".$session->oauth_gmail.",template=candidate_page,status<" .Page::statusTrash)== ""){
		header("Location: ".$pages->get("name=form")->url);
	}
	else{
		$user_page = $pages->get("oauth_gmail=".$session->oauth_gmail.",status<" .Page::statusTrash);
	}
