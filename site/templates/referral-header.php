...
<body id="page-top">
   ...
   <!--             </a>-->
		...
		<div id="content-wrapper" class="d-flex flex-column content_dashboard" style="">
            ...
            <img src="<?=$rootpath;?>images/Tag_Web_Banner.jpg" class="[ img-fluid ]( mobile-hide )" alt="Pride Circle Banner Image">
             <img src="<?=$rootpath;?>images/Tag_Mobile_Banner.jpg" class="[ img-fluid ]( mobile-show )" alt="Pride Circle Banner Image">
            </div>
				<!-- Topbar -->
