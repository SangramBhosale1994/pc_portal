...
// 			}
      ...
      $recruiter_data->job_posted_count=$job_posted_count;
			...
			$posted_jobs_link=wire('config')->urls->httpRoot."resume/pc-editor/editor-manage-jobs/?job_added_by=".$recruiter_page->id;
	...
	function modify_recruiter($edit_profile_form_details){
		...
		// $single_recruiter=wire('pages')->get("name=recruiters")->child("email=".$edit_recruiter_details_to_save['recruiter_email']);
	...
	function create_recruiter($new_recruiter_form_details){
		...
		$recruiter_page=wire('pages')->get("name=recruiters")->children();
